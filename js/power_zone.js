...
const PowerZone = {
    ...
    SOURCES: [
        {
            ...
            operator: 'Utility-scale IPP',
            offtaker: 'AI data-center PPAs',
            online: 'Operational',
            milestone:
                'Solar+BESS became the fastest new power AI builders can buy — most of the 2026 US interconnection queue is exactly this.',
            facts: [
        ...
        },
        {
            ...
            offtaker: 'Western grid + tech PPAs',
            online: 'Operational 2026',
            milestone:
                'SunZia: ~3.5 GW of wind + a dedicated 550-mile transmission line — proof that the grid, not the turbine, is the hard part.',
            facts: [
        ...
        },
        {
            ...
            offtaker: 'Microsoft (20-yr PPA, 100%)',
            online: 'Restart on track for 2027',
            milestone:
                'Jun 8, 2026: NRC released a draft environmental assessment finding no significant impact from the Crane/TMI Unit 1 restart — public comment ran through Jul 8, 2026, setting up a final NRC decision.',
            facts: [
        ...
        },
        {
            ...
            operator: 'On-site behind-the-meter',
        ...
        },
        {
            ...
            operator: 'Federal hydro system',
            offtaker: 'PNW data-center corridor',
            online: 'Operational since 1957',
            milestone:
                'The original AI power play: Columbia River hydro is why hyperscale data centers colonized Oregon and Washington in the first place.',
            facts: [
        ...
        },
        {
            ...
            offtaker: 'Google via TVA',
            online: 'Under construction · online 2030',
            status: 'construction',
            milestone:
                'Apr 2026: Kairos broke ground on Hermes 2 — first power-producing Gen IV reactor with an NRC construction permit, 50 MW to TVA for Google.',
            facts: [
    ...
    NPCS: [
        ...
        },
        {
            id: 'npc_solar_eng',
            name: 'Solar Engineer',
            role: 'PV + BESS Maintenance',
            workplace: 'power_solar',
            color: '#fbbf24',
            shift: 'day',
        },
        {
            id: 'npc_turbine_tech',
            name: 'Turbine Tech',
            role: 'Wind Turbine Engineer',
            workplace: 'power_wind',
            color: '#60a5fa',
            shift: 'day',
        },
        {
            id: 'npc_coal_foreman',
            name: 'Turbine Foreman',
            role: 'Gas Genset Operations',
            workplace: 'power_coal',
            color: '#94a3b8',
            shift: 'night',
        },
        {
            id: 'npc_dam_keeper',
            name: 'Dam Keeper',
            role: 'Hydroelectric Ops',
            workplace: 'power_hydro',
            color: '#06b6d4',
            shift: 'day',
        },
        {
        ...
        },
        {
            ...
            role: 'Polaris Pulse Ops',
            workplace: 'power_fusion',
            color: '#c084fc',
            shift: 'night',
        },
    ],
