...
const EmbassyQuarter = {
    BLDS: [
        {
            id: 'diplomat_villa_us',
            name: "US Ambassador's Residence",
            w: 130,
            fl: 3,
            emoji: '🇺🇸',
            type: 'diplomat_villa',
        ...
        {
            id: 'diplomat_villa_cn',
            name: "Chinese Ambassador's Residence",
            w: 130,
            fl: 3,
            emoji: '🇨🇳',
            type: 'diplomat_villa',
        ...
        {
            id: 'diplomat_villa_eu',
            name: "EU Representative's Residence",
            w: 130,
            fl: 3,
            emoji: '🇪🇺',
            type: 'diplomat_villa',
        ...
        {
            id: 'diplomat_villa_uk',
            name: "UK High Commissioner's Residence",
            w: 130,
            fl: 3,
            emoji: '🇬🇧',
            type: 'diplomat_villa',
        ...
        {
            id: 'diplomat_villa_in',
            name: "Indian High Commissioner's Residence",
            w: 130,
            fl: 3,
            emoji: '🇮🇳',
            type: 'diplomat_villa',
        ...
        {
            id: 'diplomat_villa_ae',
            name: "UAE Ambassador's Residence",
            w: 130,
            fl: 3,
            emoji: '🇦🇪',
            type: 'diplomat_villa',
    ...
    renderExterior(b, container, gfx, h) {
        ...
        switch (style) {
            case 'georgian':
                this._drawGeorgian(b, container, gfx, h, flagCols, accent);
                break;
            case 'pagoda':
                this._drawPagoda(b, container, gfx, h, flagCols, accent);
                break;
            case 'haussmann':
                this._drawHaussmann(b, container, gfx, h, flagCols, accent);
                break;
            case 'victorian':
                this._drawVictorian(b, container, gfx, h, flagCols, accent);
                break;
            case 'haveli':
                this._drawHaveli(b, container, gfx, h, flagCols, accent);
                break;
            case 'arabian':
                this._drawArabian(b, container, gfx, h, flagCols, accent);
                break;
            default:
                this._drawGeorgian(b, container, gfx, h, flagCols, accent);
                break;
    ...
    _drawGeorgian(b, container, gfx, h, flagCols, accent) {
        ...
        gfx.lineStyle(0);
        // Stone foundation
        gfx.beginFill(0xb0a890);
        gfx.drawRect(0, h - 6, W, 6);
        gfx.endFill();
        ...
        gfx.beginFill(0x7a2b1f);
        gfx.drawRect(W - 26, -14, 10, 18);
        gfx.endFill();
        gfx.beginFill(0x5a1e14);
        gfx.drawRect(W - 26, -16, 10, 2);
        gfx.endFill();
        ...
        const portW = 34,
            portX = W / 2 - portW / 2,
            portY = h - 26;
        gfx.beginFill(0xfffbe8);
        gfx.drawRect(portX, portY, portW, 20);
        gfx.endFill();
        // Two Doric columns
        for (const cx of [portX + 4, portX + portW - 8]) {
            gfx.beginFill(0xfffbe8);
            gfx.drawRect(cx, portY - 4, 4, 22);
            gfx.endFill();
            gfx.beginFill(0xcfc8ad, 0.7);
            gfx.drawRect(cx + 2, portY - 4, 2, 22);
            gfx.endFill();
            gfx.beginFill(0xe8e0c5);
            gfx.drawRect(cx - 1, portY - 6, 6, 2);
            gfx.endFill();
        }
        ...
        const dW = 10,
            ...
            dX = W / 2 - dW / 2,
            dY = h - dH - 6;
        gfx.beginFill(0x8b1a1a);
        gfx.drawRect(dX, dY, dW, dH);
        gfx.endFill();
        gfx.beginFill(0x6b1212);
        gfx.drawRect(dX + 1, dY + 1, dW - 2, dH - 2);
        gfx.endFill();
        gfx.beginFill(0xfbbf24);
        gfx.drawCircle(dX + dW - 2, dY + dH / 2, 0.7);
        gfx.endFill();
        ...
        for (const wy of winRows) {
            ...
            for (const wx of [W * 0.22 - 7, W * 0.78 - 7]) {
                ...
                gfx.beginFill(0x1a1810);
                gfx.drawRect(wx - 2, wy, 2, 12);
                gfx.endFill();
                gfx.beginFill(0x1a1810);
                gfx.drawRect(wx + 14, wy, 2, 12);
                gfx.endFill();
                // Window glass
                gfx.beginFill(0x1a1a28);
                gfx.drawRect(wx, wy, 14, 12);
                gfx.endFill();
                gfx.beginFill(0xffe9a8, 0.55);
                gfx.drawRect(wx + 1, wy + 1, 12, 10);
                gfx.endFill();
                // Muntin cross
                gfx.lineStyle(0.4, 0xf4efe2, 0.8);
                gfx.moveTo(wx + 7, wy + 1);
                gfx.lineTo(wx + 7, wy + 11);
                gfx.moveTo(wx + 1, wy + 6);
                gfx.lineTo(wx + 13, wy + 6);
                gfx.lineStyle(0);
            }
        }
    },
    ...
    _drawPagoda(b, container, gfx, h, flagCols, accent) {
        ...
        gfx.beginFill(0x7a1a1a);
        gfx.drawRect(0, 0, W, h);
        gfx.endFill();
        gfx.beginFill(0x951f20);
        gfx.drawRect(2, 2, W - 4, h - 6);
        gfx.endFill();
        // Stone foundation
        gfx.beginFill(0x5a5248);
        gfx.drawRect(0, h - 6, W, 6);
        gfx.endFill();
        ...
        // Gold ridge ornament
        gfx.beginFill(0xd4a83b);
        gfx.drawCircle(W / 2, -24, 2);
        gfx.endFill();
        gfx.beginFill(0xffe27a);
        gfx.drawCircle(W / 2, -25, 1);
        gfx.endFill();
        ...
        gfx.endFill();
        gfx.beginFill(0x5a0e0e);
        gfx.drawRect(dX, dY, dW, dH);
        gfx.endFill();
        gfx.beginFill(0x3a0808);
        gfx.drawRect(dX + 1, dY + 1, dW - 2, dH - 2);
        gfx.endFill();
        ...
        for (const lx of [dX - 10, dX + dW + 10]) {
            ...
            gfx.drawRect(lx - 0.5, dY + 2, 1, 3);
            gfx.endFill();
            gfx.beginFill(0xd4a83b);
            gfx.drawCircle(lx, dY + 10, 2.4);
            gfx.endFill();
            gfx.beginFill(0xff4a2b, 0.9);
            gfx.drawCircle(lx, dY + 10, 2);
            gfx.endFill();
            gfx.beginFill(0xfff1c2, 0.6);
            gfx.drawCircle(lx, dY + 10, 0.9);
            gfx.endFill();
        }
        ...
        for (const wy of [h - 46, h - 66]) {
            ...
            for (const wx of [W * 0.22, W * 0.78]) {
                gfx.beginFill(0xd4a83b);
                gfx.drawCircle(wx, wy + 6, 6);
                gfx.endFill();
                gfx.beginFill(0x1a1a28);
                gfx.drawCircle(wx, wy + 6, 5);
                gfx.endFill();
                gfx.beginFill(0xffe9a8, 0.55);
                gfx.drawCircle(wx, wy + 6, 4);
                gfx.endFill();
                // Lattice cross
                gfx.lineStyle(0.4, 0xd4a83b, 0.8);
                gfx.moveTo(wx - 4, wy + 6);
                gfx.lineTo(wx + 4, wy + 6);
                gfx.moveTo(wx, wy + 2);
                gfx.lineTo(wx, wy + 10);
                gfx.lineStyle(0);
            }
    ...
    _drawHaussmann(b, container, gfx, h, flagCols, accent) {
        const W = b.w;
        // Limestone body
        gfx.beginFill(0xe8dfc7);
        gfx.drawRect(0, 0, W, h);
        gfx.endFill();
        gfx.beginFill(0xf2eacf);
        gfx.drawRect(2, 2, W - 4, h - 6);
        gfx.endFill();
        ...
        for (const dx of [W * 0.3 - 4, W * 0.7 - 4]) {
            ...
            gfx.drawRect(dx, -11, 8, 7);
            gfx.endFill();
            gfx.beginFill(0xffe9a8, 0.6);
            gfx.drawRect(dx + 1, -10, 6, 5);
            gfx.endFill();
        ...
        const dW = 12,
            ...
            dX = W / 2 - dW / 2,
            dY = h - dH - 6;
        gfx.beginFill(0xd4b066);
        gfx.drawRect(dX - 2, dY - 2, dW + 4, dH + 4);
        gfx.endFill(); // gold frame
        gfx.beginFill(0x3a2a1a);
        gfx.drawRect(dX, dY + 2, dW, dH - 2);
        gfx.endFill();
        gfx.beginFill(0x3a2a1a);
        gfx.drawCircle(dX + dW / 2, dY + 2, dW / 2);
        gfx.endFill(); // arched top
        gfx.beginFill(0x2a1a10);
        gfx.drawRect(dX + 1, dY + 3, dW - 2, dH - 4);
        gfx.endFill();
        // Gold door split + handle
        gfx.lineStyle(0.5, 0xd4b066, 0.9);
        gfx.moveTo(dX + dW / 2, dY + 4);
        gfx.lineTo(dX + dW / 2, dY + dH - 2);
        gfx.lineStyle(0);
        gfx.beginFill(0xd4b066);
        gfx.drawCircle(dX + dW / 2 + 2, dY + dH / 2, 0.8);
        ...
        for (const wy of winRows) {
            ...
            for (const wx of [W * 0.2 - 7, W * 0.8 - 7]) {
                gfx.beginFill(0xcfc2a3);
                gfx.drawRect(wx - 1, wy - 1, 16, 14);
                gfx.endFill(); // stone frame
                gfx.beginFill(0x1a1a28);
                gfx.drawRect(wx, wy, 14, 12);
                gfx.endFill();
                gfx.beginFill(0xffe9a8, 0.55);
    ...
    _drawVictorian(b, container, gfx, h, flagCols, accent) {
        const W = b.w;
        // Red brick body
        gfx.beginFill(0x8b3a2e);
        gfx.drawRect(0, 0, W, h);
        gfx.endFill();
        gfx.beginFill(0xa04432);
        gfx.drawRect(2, 2, W - 4, h - 6);
        gfx.endFill();
        // Brick pattern
        ...
        for (const cx of [W * 0.2, W * 0.8]) {
            gfx.beginFill(0x7a2a20);
            gfx.drawRect(cx - 4, -16, 8, 18);
            gfx.endFill();
            gfx.beginFill(0x5a1e18);
            gfx.drawRect(cx - 4, -18, 8, 2);
            gfx.endFill();
            // Chimney pots
            gfx.beginFill(0x3a1a14);
            gfx.drawRect(cx - 3, -22, 2, 4);
            gfx.endFill();
            gfx.beginFill(0x3a1a14);
            gfx.drawRect(cx + 1, -22, 2, 4);
            gfx.endFill();
        }
        ...
        const bayW = 40,
            ...
            bayY = h - 34;
        gfx.beginFill(0x8b3a2e);
        gfx.drawRect(bayX - 2, bayY, bayW + 4, 22);
        gfx.endFill();
        gfx.beginFill(0xddd0b8);
        gfx.drawRect(bayX - 2, bayY, bayW + 4, 2);
        gfx.endFill(); // top trim
        // Three bay window panes
        for (let i = 0; i < 3; i++) {
            const bx = bayX + 2 + i * ((bayW - 4) / 3);
            const bw = (bayW - 4) / 3 - 2;
            gfx.beginFill(0x1a1a28);
            gfx.drawRect(bx, bayY + 4, bw, 14);
            gfx.endFill();
            gfx.beginFill(0xffe9a8, 0.55);
            gfx.drawRect(bx + 0.5, bayY + 4.5, bw - 1, 13);
            gfx.endFill();
            gfx.lineStyle(0.3, 0xddd0b8, 0.7);
            gfx.moveTo(bx + bw / 2, bayY + 4);
            gfx.lineTo(bx + bw / 2, bayY + 18);
            gfx.lineStyle(0);
        }
        ...
        const dW = 10,
            ...
            dY = h - dH - 6;
        gfx.beginFill(0xddd0b8);
        gfx.drawRect(dX - 2, dY - 3, dW + 4, dH + 4);
        gfx.endFill();
        ...
        // Brass knocker
        gfx.beginFill(0xd4a83b);
        gfx.drawCircle(dX + dW / 2, dY + 6, 1.2);
        gfx.endFill();
    ...
    _drawHaveli(b, container, gfx, h, flagCols, accent) {
        ...
        for (const ux of [6, W - 10]) {
            ...
            gfx.endFill();
            // Dome
            gfx.beginFill(0xfff2c4);
            gfx.drawCircle(ux + 3, -15, 4);
            gfx.endFill();
            gfx.beginFill(0xd4a83b);
            gfx.drawRect(ux + 2, -18, 2, 3);
            gfx.endFill(); // finial
            gfx.beginFill(0xd4a83b);
            gfx.drawCircle(ux + 3, -19, 0.8);
            gfx.endFill();
        }
        ...
        const jW = 40,
            ...
            jY = h - 50;
        gfx.beginFill(0xa05c2f);
        gfx.drawRect(jX - 4, jY, jW + 8, 20);
        gfx.endFill();
        gfx.beginFill(0xd88a5a);
        gfx.drawRect(jX - 2, jY + 2, jW + 4, 16);
        gfx.endFill();
        // Jaali (lattice) pattern
        gfx.beginFill(0x1a1a28);
        gfx.drawRect(jX, jY + 4, jW, 12);
        gfx.endFill();
        gfx.beginFill(0xffe9a8, 0.55);
        gfx.drawRect(jX + 1, jY + 5, jW - 2, 10);
        gfx.endFill();
        ...
        const dW = 12,
            ...
            dX = W / 2 - dW / 2,
            dY = h - dH - 6;
        gfx.beginFill(0xff9933);
        gfx.drawRect(dX - 2, dY - 3, dW + 4, dH + 4);
        gfx.endFill(); // saffron frame
        gfx.beginFill(0xd4a83b);
        gfx.drawRect(dX - 1, dY - 2, dW + 2, dH + 2);
        gfx.endFill(); // gold inner
        gfx.beginFill(0x4a2a10);
        gfx.drawRect(dX, dY + 3, dW, dH - 3);
        gfx.endFill();
        gfx.beginFill(0x4a2a10);
        gfx.drawCircle(dX + dW / 2, dY + 3, dW / 2);
        gfx.endFill(); // arched top
        gfx.beginFill(0x3a1a08);
        gfx.drawRect(dX + 1, dY + 4, dW - 2, dH - 5);
        gfx.endFill();
        gfx.beginFill(0xd4a83b);
        gfx.drawCircle(dX + dW / 2 + 2, dY + dH / 2, 0.9);
        gfx.endFill();
        ...
        for (const wx of [W * 0.15, W * 0.85]) {
            const ww = 10,
                wh = 14;
            gfx.beginFill(0xd4a83b);
            gfx.drawRect(wx - ww / 2 - 1, dY - 1, ww + 2, wh + 2);
            gfx.endFill();
            gfx.beginFill(0x1a1a28);
            gfx.drawRect(wx - ww / 2, dY + 2, ww, wh - 2);
            gfx.endFill();
            gfx.beginFill(0x1a1a28);
            gfx.drawCircle(wx, dY + 2, ww / 2);
            gfx.endFill();
            gfx.beginFill(0xffe9a8, 0.55);
            gfx.drawCircle(wx, dY + 2, ww / 2 - 1);
            gfx.endFill();
            gfx.beginFill(0xffe9a8, 0.55);
            gfx.drawRect(wx - ww / 2 + 1, dY + 2, ww - 2, wh - 4);
            gfx.endFill();
        }
    },
    ...
    _drawArabian(b, container, gfx, h, flagCols, accent) {
        const W = b.w;
        // Cream stucco body
        gfx.beginFill(0xede3c8);
        gfx.drawRect(0, 0, W, h);
        gfx.endFill();
        gfx.beginFill(0xf5ecd1);
        gfx.drawRect(2, 2, W - 4, h - 6);
        gfx.endFill();
        ...
        gfx.beginFill(0xede3c8);
        gfx.drawCircle(W / 2, -8, 8);
        gfx.endFill();
        gfx.beginFill(0xc9b98a);
        gfx.drawCircle(W / 2, -6, 8);
        gfx.endFill();
        gfx.beginFill(0xede3c8);
        gfx.drawCircle(W / 2, -8, 7);
        gfx.endFill();
        // Gold crescent + star finial
        gfx.beginFill(0xd4a83b);
        gfx.drawRect(W / 2 - 0.5, -18, 1, 5);
        gfx.endFill();
        gfx.beginFill(0xd4a83b);
        gfx.drawCircle(W / 2, -19, 1.4);
        gfx.endFill();
        gfx.beginFill(0xede3c8);
        gfx.drawCircle(W / 2 + 0.6, -18.8, 1.2);
        gfx.endFill(); // crescent cutout
        ...
        const dW = 14,
            ...
            dY = h - dH - 6;
        gfx.beginFill(0xd4a83b);
        gfx.drawRect(dX - 3, dY - 3, dW + 6, dH + 3);
        gfx.endFill();
        gfx.beginFill(0xd4a83b);
        gfx.drawCircle(dX + dW / 2, dY - 3, (dW + 6) / 2);
        gfx.endFill();
        ...
        gfx.endFill();
        gfx.beginFill(0xd4a83b);
        gfx.drawCircle(dX + dW / 2, dY + dH - 3, 0.9);
        gfx.endFill();
        ...
        for (const wy of [h - 48, h - 68]) {
            ...
            for (const wx of [W * 0.2 - 6, W * 0.8 - 6]) {
                ...
                gfx.beginFill(0xd4a83b);
                gfx.drawRect(wx - 1, wy, ww + 2, wh + 1);
                gfx.endFill();
                gfx.beginFill(0xd4a83b);
                gfx.drawCircle(wx + ww / 2, wy, (ww + 2) / 2);
                gfx.endFill();
                // Dark window interior
                gfx.beginFill(0x1a1a28);
                gfx.drawRect(wx, wy + 1, ww, wh - 1);
                gfx.endFill();
                gfx.beginFill(0x1a1a28);
                gfx.drawCircle(wx + ww / 2, wy + 1, ww / 2);
                gfx.endFill();
                // Warm glow
                gfx.beginFill(0xffe9a8, 0.55);
                gfx.drawRect(wx + 1, wy + 2, ww - 2, wh - 3);
                gfx.endFill();
                gfx.beginFill(0xffe9a8, 0.55);
                gfx.drawCircle(wx + ww / 2, wy + 1, ww / 2 - 1);
                gfx.endFill();
                // Mashrabiya lattice (fine cross pattern)
                gfx.lineStyle(0.3, 0xd4a83b, 0.7);
                gfx.moveTo(wx + ww / 2, wy);
                gfx.lineTo(wx + ww / 2, wy + wh);
                gfx.moveTo(wx, wy + wh / 2);
                gfx.lineTo(wx + ww, wy + wh / 2);
                gfx.moveTo(wx + 3, wy + 2);
                gfx.lineTo(wx + ww - 3, wy + wh - 1);
                gfx.moveTo(wx + ww - 3, wy + 2);
                gfx.lineTo(wx + 3, wy + wh - 1);
                gfx.lineStyle(0);
            }
        }
        ...
        const palmX = W + 6,
            palmY = h - 6;
        gfx.beginFill(0x5a3e1f);
        gfx.drawRect(palmX - 1, palmY - 14, 2, 14);
        gfx.endFill();
    ...
    _addFlagpole(b, container, flagCols) {
        ...
        pole.drawRect(-1, -20, 2, 22);
        pole.endFill();
        pole.beginFill(0xfbbf24);
        pole.drawCircle(0, -20, 1.4);
        pole.endFill();
