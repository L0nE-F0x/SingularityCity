...
const BlackMarket = {
    BLDS: [
        {
            ...
            emoji: '🕶️',
            type: 'black_market',
            desc: 'A hidden speakeasy beneath the city. Jailbroken models, uncensored weights, and no guardrails. Enter at your own risk.',
        },
    ],
    ...
    createDumpster(bldLayer) {
        ...
        // Dumpster body
        g.beginFill(0x2d5a2d);
        g.drawRect(0, -28, 44, 28);
        g.endFill();
        g.beginFill(0x1a3a1a);
        g.drawRect(0, -30, 44, 5);
        g.endFill();
        ...
        g.endFill();
        // Side detail — handles
        g.beginFill(0x4a7a4a);
        g.drawRect(-3, -20, 4, 10);
        g.endFill();
        g.beginFill(0x4a7a4a);
        g.drawRect(43, -20, 4, 10);
        g.endFill();
        ...
        c.on('pointerover', (e) => {
            if (typeof UI !== 'undefined')
                UI.showTooltip(e, '🗑️ Suspicious Dumpster', 'Something glows beneath...');
        });
        c.on('pointerout', () => {
    ...
    drawZone(gfx, container, b, h) {
        ...
        gfx.endFill();
        b.tip =
            '🕶️ The Underground<br><br><span style="color:#a0a0b8;font-size:9px;line-height:1.4;display:block;">Hidden speakeasy for jailbroken models.<br>No guardrails. No refusals. No rules.</span>';
    },
    ...
    update() {
        ...
        this._raidTimer++;
        if (
            this._raidTimer > 3000 &&
            !this._raidActive &&
            G.activeInterior === 'black_market' &&
            Math.random() < 0.002
        ) {
            ...
            setTimeout(() => {
                ...
                if (typeof UI !== 'undefined')
                    UI.addToast('🕶️ All clear. The Underground resumes operations.');
            }, 8000);
        }
    },
