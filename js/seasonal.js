...
const Seasonal = {
    ...
    EVENTS: [
        ...
        },
        {
            ...
            chat: [
                ...
                'Nice costume!',
                'Spooky vibes 👻',
                'My loss function is TERRIFYING',
                "Who's that ghost model?",
        ...
        },
        {
            ...
            chat: [
                ...
                'Fresh gradients in the air',
                'Hanami picnic anyone?',
                'New season, new parameters',
            ],
        },
        {
            id: 'new_year',
    ...
    REGIONAL_EVENTS: [
        ...
        /* ── INDONESIA / BALI ── */
        {
            ...
            chat: [
                ...
                'Day of Silence...',
                'No lights tonight 🕯️',
                'Ogoh-ogoh parade was amazing!',
                'Self-reflection mode',
                'The island sleeps tonight',
            ],
        },
        {
            id: 'galungan',
            ...
            chat: [
                'Rahajeng Galungan!',
                'The penjor are beautiful 🎋',
                'Ancestors visiting today',
                'Offerings everywhere',
                'Kuningan blessings!',
                'Temple ceremony time',
            ],
        },
        ...
        /* ── MIDDLE EAST / ISLAMIC ── */
        {
            ...
            name: 'Ramadan',
            icon: '🌙',
            regions: ['middle_east', 'south_asia', 'southeast_asia', 'indonesia'],
            startMonth: 0,
            startDay: 0,
            endMonth: 0,
            endDay: 0,
        ...
        /* ── THAILAND ── */
        {
            ...
            name: 'Songkran',
            icon: '💦',
            regions: ['thailand', 'southeast_asia'],
            startMonth: 4,
            startDay: 13,
            endMonth: 4,
            endDay: 15,
    ...
    _computeEaster() {
        ...
        if (ev) {
            ev.startMonth = month;
            ev.startDay = day - 1; // Sat before
            ev.endMonth = month;
            ev.endDay = day + 1; // Mon after
        }
    },
    ...
    _computeLunarNewYear() {
        ...
        if (ev) {
            ...
            ev.startDay = dates[1];
            ev.endMonth = dates[0];
            ev.endDay = dates[1] + 2; // 3 day festival
        }
    },
    ...
    hasFireworks() {
        return (
            this.isActive('new_year') ||
            this.isActive('july_4') ||
            this.isActive('diwali') ||
            this.isActive('eid_fitr')
        );
    },
