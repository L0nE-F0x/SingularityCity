...
(function () {
    ...
    const STEPS = [
        ...
        },
        {
            ...
            bodyDesktop:
                'The streets are full of <b>AI models walking around as little characters</b>. Each one is a real model — sized by parameter count, colored by lab. They age (baby → kid → adult → retired), commute, sleep, and have unique appearances based on their architecture.',
            bodyMobile:
                'Every little character is a <b>real AI model</b> — sized by parameter count, colored by lab. They age, commute, sleep, and live their lives.',
            target: null,
            placement: 'center',
            onEnter: function () {
        ...
        },
        {
            ...
            bodyDesktop:
                "<b>Click any character</b> for their full profile. <b>Click any building</b> to enter its interior. <b>Drag to pan</b> across the city, and <b>scroll to zoom</b>. We'll cover the rest in the steps ahead.",
            bodyMobile:
                "<b>Tap any character</b> for their profile. <b>Tap any building</b> to enter. <b>Swipe to pan</b>, <b>pinch to zoom</b>. Let's go.",
            target: null,
            placement: 'center',
        },
        ...
        // ════════ CHAPTER 2 — TOP BAR & DASHBOARDS ════════
        {
            ...
            bodyDesktop:
                "This top bar is your command center. Every button opens a different dashboard — leaderboards, census, calendars, costs, news, achievements, and more. Let's go through the most important ones.",
            bodyMobile:
                'This is the control bar. Scroll it sideways to see all the buttons. Each opens a different dashboard.',
            target: '#ctrlBar',
            placement: 'bottom',
        },
        {
        ...
        // ════════ CHAPTER 4 — INTERACTION ════════
        {
            ...
            bodyDesktop:
                'Click any AI model or CEO, then press <b>📡 Track</b> to lock the camera on them. The camera follows them everywhere — through metro tunnels, into building interiors, up elevators, into helicopters. Drag to cancel.',
            bodyMobile:
                'Tap any character, then tap <b>📡 Track</b>. The camera follows them everywhere — through tunnels, into buildings, up elevators. Tap-and-drag to cancel.',
            target: null,
            placement: 'center',
        },
        {
            ...
            title: '🗺️ Minimap',
            bodyDesktop:
                "The <b>minimap</b> in the bottom-right shows the whole city. Click any zone label to fast-travel there. There's also a <b>🛰️ Orbit</b> button that pulls the camera up into <b>Low Earth Orbit</b> where you can see the curvature of Earth and real satellite positions from CelesTrak.",
            bodyMobile:
                'The <b>minimap</b> shows the whole city. Tap zone labels to fast-travel. The <b>🛰️ Orbit</b> button enters Low Earth Orbit with real satellite tracking.',
            target: '#minimap',
            placement: 'left',
        },
        {
        ...
        // ════════ CHAPTER 5 — FINALE ════════
        {
            ...
            bodyDesktop:
                "That's the full tour! There's much more to discover — easter eggs, seasonal events, the black market, the city park, weekly newspaper, achievements, and more. <b>Click anything that catches your eye.</b><br><br>You can re-open this tutorial anytime from the <b>❓ How It Works</b> panel.",
            bodyMobile:
                "That's the tour! There's lots more to discover — events, easter eggs, achievements, hidden zones. Tap anything that catches your eye.<br><br>Re-open this tutorial anytime from <b>❓ How It Works</b>.",
            target: null,
            placement: 'center',
        },
    ];
    ...
    const Tutorial = {
        ...
        start() {
            ...
            try {
                localStorage.setItem('tutorial_started', '1');
            } catch (e) {}
            ...
            if (landingVisible && typeof window.enterCity === 'function') {
                try {
                    ...
                    console.warn('[Tutorial] enterCity failed', e);
                }
        ...
        _teardown() {
            ...
            this._active = false;
            if (this._ov) {
                this._ov.classList.remove('active');
            }
        ...
        _render(skipOnEnter) {
            ...
            const bodyHTML =
                IS_MOBILE && step.bodyMobile
                    ? step.bodyMobile
                    : !IS_MOBILE && step.bodyDesktop
                      ? step.bodyDesktop
