...
const SPACE_ORGS = {
    spacex: {
        ...
        region: 'us',
        hq: 'Starbase, Texas',
        founded: '2002 · merged with xAI Jan 2026',
        vehicle: 'Starship V3',
        program: 'AI1 orbital data-center constellation',
        milestone:
            'Jul 24, 2026: Starship Flight 13 deployed the first 20 next-gen Starlink V3 satellites and ended in the softest Starship splashdown yet — though the booster hit the Gulf hard with only 5 of 13 landing engines lit.',
        facts: [
    ...
    blue_origin: {
        ...
        milestone:
            'Jul 6, 2026: Blue Origin cleared all LC-36 debris in 9 days and began rebuilding the pad in a horizontal/vertical hybrid config — CEO Dave Limp reaffirmed New Glenn will fly again before year-end 2026.',
        facts: [
    ...
    nasa: {
        ...
        milestone:
            'Apr 10, 2026: Artemis II crew (Wiseman, Glover, Koch, Hansen) splashed down after a 10-day trip around the Moon.',
        facts: [
    ...
    cnsa: {
        ...
        hq: 'Beijing',
        founded: '1993',
        vehicle: 'Long March 10',
        program: 'Crewed Moon landing before 2030 + Tiangong station',
        milestone:
            "Feb 11, 2026: Long March 10A test stage flew the Mengzhou crew capsule's launch-escape demo — booster fished out of the South China Sea.",
        facts: [
    ...
    esa: {
        ...
        milestone:
            'Apr 30, 2026: Ariane 6 flew its most powerful 4-booster configuration, lofting 32 Amazon Leo broadband satellites.',
        facts: [
    ...
    ula: {
        ...
        milestone:
            'Jul 2, 2026: ULA flew its final-ever Atlas V (Amazon Leo satellites) — closing a 100% mission-success run — while Vulcan stays grounded pending the Feb 2026 booster investigation.',
        facts: [
    ...
    rocketlab: {
        ...
        founded: '2006',
        vehicle: 'Electron / Neutron',
        program: 'Dedicated smallsat launch + Neutron reusable medium-lift',
        milestone:
            "May 2026: signed a five-launch Neutron deal while targeting Neutron's debut from Wallops in late 2026.",
        facts: [
    ...
    isro: {
        ...
        milestone:
            "Jul 5, 2026: ISRO test-fired the SOLVE sub-orbital motor at Sriharikota to validate Gaganyaan's crew-module parachute recovery system; uncrewed Gaganyaan-1 still targets H2 2026.",
        facts: [
    ...
    jaxa: {
        ...
        milestone:
            'H3 is ramping cadence from Tanegashima, flying HTV-X cargo to the ISS and co-developing lunar tech with Artemis.',
        facts: [
    ...
    roscosmos: {
        ...
        milestone:
            'Soyuz keeps its unbroken crew-rotation record to the ISS from Baikonur — the longest-serving human launch system in history.',
        facts: [
    ...
    northrop_grumman: {
        ...
        milestone:
            'Antares 330 pairs a new Firefly-built first stage with Cygnus cargo ships bound for the ISS from Wallops Island.',
        facts: [
    ...
    firefly: {
        ...
        milestone:
            "Blue Ghost Mission 2 launches late 2026 — a far-side Moon landing, stacked on Firefly's Elytra Dark transfer vehicle.",
        facts: [
    ...
    landspace: {
        ...
        milestone:
            'Dec 3, 2025: Zhuque-3 reached orbit on its debut — the booster crashed 17 s before touchdown; a "perfect landing" is the 2026 goal.',
        facts: [
...
const SPACE_BLDS = [
    // Launch pads — each org gets a pad + mission control
    {
        ...
        org: 'spacex',
        type: 'launchpad',
        desc: 'Starship V3 launch mount with Mechazilla catch tower. Every flight lofts AI1 orbital data-center hardware for the merged SpaceX • xAI constellation.',
    },
    {
        id: 'pad_blue_origin',
        name: 'LC-36',
        ...
        org: 'blue_origin',
        type: 'launchpad',
        desc: "Cape Canaveral Launch Complex 36 — New Glenn's home pad, being rebuilt after the May 2026 static-fire anomaly. Booster reflights land downrange on the barge Jacklyn.",
    },
    {
        id: 'pad_nasa',
        name: 'LC-39B',
        ...
        org: 'nasa',
        type: 'launchpad',
        desc: 'Kennedy Space Center Pad 39B — the Artemis pad. SLS launched the Artemis II crew around the Moon from here in 2026.',
    },
    {
        id: 'pad_cnsa',
        name: 'Wenchang LC-2',
        ...
        org: 'cnsa',
        type: 'launchpad',
        desc: 'Wenchang Spacecraft Launch Site, Hainan. Long March 10 Moon-rocket flights and Tiangong station logistics.',
    },
    {
        id: 'pad_esa',
        name: 'ELA-4',
        ...
        org: 'esa',
        type: 'launchpad',
        desc: "Europe's Spaceport, Kourou. Ariane 64 flies with four boosters here, hauling 32-satellite Amazon Leo batches to LEO.",
    },
    {
        id: 'pad_ula',
        name: 'SLC-41',
        ...
        org: 'ula',
        type: 'launchpad',
        desc: 'Cape Canaveral Space Launch Complex 41. Vulcan Centaur flies national-security missions direct to GEO — 18–22 launches targeted in 2026.',
    },
    {
        id: 'pad_rocketlab',
        name: 'LC-1A',
        ...
        org: 'rocketlab',
        type: 'launchpad',
        desc: "Launch Complex 1, Māhia Peninsula, New Zealand — the world's only private orbital launch site. Electron flies here; Neutron debuts from Wallops.",
    },
    {
        id: 'pad_northrop_grumman',
        name: 'MARS Pad-0A',
        w: 140,
        fl: 1,
        org: 'northrop_grumman',
        type: 'launchpad',
        desc: 'Mid-Atlantic Regional Spaceport Pad 0A, Wallops Island. Antares 330 launches Cygnus cargo freighters to the ISS.',
    },
    {
        id: 'pad_firefly',
        name: 'SLC-2W',
        ...
        org: 'firefly',
        type: 'launchpad',
        desc: 'Vandenberg SLC-2 West. Firefly Alpha responsive launches — and the staging point for Blue Ghost lunar landers.',
    },
    {
        id: 'pad_landspace',
        name: 'JSLC LC-96',
        ...
        org: 'landspace',
        type: 'launchpad',
        desc: 'Jiuquan Satellite Launch Centre, Gobi Desert. Stainless-steel Zhuque-3 launches and landing-recovery attempts.',
    },
    {
        id: 'pad_isro',
        name: 'SDSC SLP',
        ...
        org: 'isro',
        type: 'launchpad',
        desc: 'Satish Dhawan Space Centre Second Launch Pad, Sriharikota. LVM3 and the human-rated Gaganyaan stack fly from here.',
    },
    {
        id: 'pad_jaxa',
        name: 'Tanegashima LP-2',
        w: 140,
        fl: 1,
        org: 'jaxa',
        type: 'launchpad',
        desc: "Tanegashima Space Center — often called the world's most beautiful launch site. H3 heavy-lift, operated with Mitsubishi Heavy Industries.",
    },
    {
        id: 'pad_roscosmos',
        name: 'Baikonur LC-31/6',
        w: 150,
        fl: 1,
        org: 'roscosmos',
        type: 'launchpad',
        desc: "Baikonur Cosmodrome Site 31, Kazakhstan. Soyuz crew rotations to the ISS — flying from the world's oldest spaceport.",
    },
    ...
    // Shared infrastructure
    {
        ...
        desc: "Modeled on NASA's DSN — three 70 m dish complexes in Goldstone, Madrid and Canberra keep contact with every probe beyond Earth orbit, plus the AI1 compute constellation.",
    },
    {
        id: 'space_assembly',
        ...
        org: null,
        type: 'assembly',
        desc: "Homage to KSC's Vehicle Assembly Building — the largest single-story building on Earth, so big it has its own weather. Rockets are stacked and mated to payloads here.",
    },
    {
        id: 'tracking_station',
        ...
        org: null,
        type: 'tracking',
        desc: 'Space-domain awareness station. Tracks 12,000+ active satellites — including the growing orbital data-center fleets — and issues conjunction warnings.',
    },
];
...
const SPACE_FOREST = {
    ...
    emoji: '🌲',
    lab: null,
    desc: 'A rugged treeline marking the boundary between the space frontier and the city.',
};
...
const SpaceData = {
    ...
    async fetchLaunches(force) {
        ...
        try {
            ...
            if (!r.ok) {
                if (r.status === 429) {
                    console.warn('[Space API] Rate limited (429). Using cached data if available.');
                    return;
                }
                return;
            }
            ...
            if (d.results) {
                ...
                try {
                    localStorage.setItem(CACHE_KEY, JSON.stringify({ ts: Date.now(), data: this.launches }));
                } catch (_) {}
    ...
    getOrgForProvider(providerName) {
        ...
        if (
            n.includes('arianespace') ||
            n.includes('esa') ||
            n.includes('european space') ||
            n.includes('avio') ||
            n.includes('isar') ||
            n.includes('rocket factory')
        )
            return 'esa';
        ...
        if (
            n.includes('casc') ||
            n.includes('china') ||
            n.includes('galactic energy') ||
            n.includes('expace') ||
            n.includes('deep blue') ||
            n.includes('ispace') ||
            n.includes('orienspace')
        )
            return 'cnsa';
        return null;
    },
