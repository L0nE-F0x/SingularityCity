...
const InteriorResProps = {
    ...
    drawRoof(roofH, startX, usableW, colHex, lab, bld) {
        ...
        if (isEstate && bld.lab === 'xai') {
            ...
            gfx.drawEllipse(startX + usableW / 2, roofH - 5, 40, 10);
            gfx.endFill();
            gfx.lineStyle(2, 0xfacc15);
            gfx.drawCircle(startX + usableW / 2, roofH - 5, 15);
            gfx.lineStyle(0);
        ...
        const textToDisplay = isEstate
            ? bld.name.toUpperCase()
            : bld.lab
              ? safeLabName.toUpperCase()
              : `${bld.emoji || ''} ${(bld.name || 'TOWER').toUpperCase()}`.trim();
    ...
    drawShower(c, x, y, style = 1) {
        ...
        if (style === 1 || style === 3) {
            ...
            g.endFill();
            g.beginFill(0x0ea5e9, 0.15);
            g.lineStyle(1, 0xcbd5e1, 0.3);
            g.drawRect(x - 14, y - 40, 28, 40);
            g.lineStyle(0);
            g.beginFill(0x94a3b8);
            g.drawRect(x - 4, y - 40, 8, 3);
            g.endFill();
            g.beginFill(0x38bdf8, 0.4);
            g.drawRect(x - 2, y - 37, 4, 25);
            g.endFill();
        } else {
            g.beginFill(0xf8fafc);
            g.drawRect(x - 18, y - 10, 36, 10);
            g.endFill();
            g.beginFill(0xe2e8f0);
            g.drawRect(x - 16, y - 40, 32, 2);
            g.endFill();
            g.beginFill(0x38bdf8, 0.2);
            g.drawRect(x - 16, y - 38, 16, 28);
            g.endFill();
            g.beginFill(0x94a3b8);
            g.drawRect(x + 10, y - 30, 4, 4);
            g.endFill();
        }
        c.addChild(g);
    },
    ...
    drawKitchen(c, x, y, region, style = 1) {
        ...
        g.drawRect(x - 25, y - 40, 14, 40);
        g.endFill();
        g.beginFill(0x94a3b8);
        g.drawRect(x - 23, y - 20, 2, 10);
        g.drawRect(x - 23, y - 35, 2, 10);
        g.endFill();

        const counterCol = style === 1 || style === 4 ? 0x1e293b : 0xb45309;
        const topCol = style === 1 || style === 4 ? 0xf1f5f9 : 0x0f172a;

        g.beginFill(counterCol);
        g.drawRect(x - 10, y - 18, 35, 18);
        g.endFill();
        g.beginFill(topCol);
        g.drawRect(x - 12, y - 18, 39, 3);
        g.endFill();

        g.beginFill(0x0ea5e9);
        g.drawRect(x - 5, y - 18, 10, 2);
        g.endFill();
        g.beginFill(0x64748b);
        g.drawRect(x - 1, y - 22, 2, 4);
        g.endFill();

        g.beginFill(0x111111);
        g.drawRect(x + 10, y - 18, 12, 2);
        g.endFill();
        g.beginFill(0xef4444);
        g.drawCircle(x + 13, y - 17, 1);
        g.drawCircle(x + 19, y - 17, 1);
        g.endFill();

        if (style === 2 || style === 3) {
            g.beginFill(counterCol);
            g.drawRect(x - 10, y - 40, 35, 10);
            g.endFill();
        } else {
            g.beginFill(0x64748b);
            g.drawRect(x + 10, y - 35, 12, 4);
            g.endFill();
        }
        c.addChild(g);
    },
    ...
    drawBed(c, x, y, region, style = 1) {
        ...
        g.drawRect(x - 22, y - 18, 6, 18);
        g.endFill();
        g.beginFill(frameCol);
        g.drawRect(x - 18, y - 6, 38, 6);
        g.endFill();
        g.beginFill(0xf1f5f9);
        g.drawRect(x - 16, y - 10, 34, 4);
        g.endFill();
        g.beginFill(duvetCol);
        g.drawRect(x - 2, y - 11, 20, 6);
        g.endFill();
        g.beginFill(0xffffff);
        g.drawRect(x - 15, y - 12, 6, 4);
        g.drawRect(x - 8, y - 12, 6, 4);
        g.endFill();
    ...
    drawLivingArea(c, x, y, style = 1) {
        ...
        g.drawRect(x - 8, y - 2, 16, 2);
        g.endFill();
        g.beginFill(0x78350f);
        g.drawRect(x - 7, y, 2, 2);
        g.drawRect(x + 5, y, 2, 2);
        g.endFill();

        const tvX = x + 25;
        g.beginFill(0x1e293b);
        g.drawRect(tvX - 10, y - 6, 20, 6);
        g.endFill();
        g.beginFill(0x0f172a);
        g.drawRect(tvX - 8, y - 20, 16, 10);
        g.endFill();
        g.beginFill(0x22d3ee);
        g.drawRect(tvX - 7, y - 19, 14, 8);
        g.endFill();
        c.addChild(g);
    ...
    drawNightstand(c, x, y, style = 1) {
        ...
        g.beginFill(0x475569);
        g.drawRect(x - 5, y - 8, 10, 8);
        g.endFill();
        g.beginFill(0x1e293b);
        g.drawRect(x - 4, y - 6, 8, 2);
        g.endFill();

        g.beginFill(0x94a3b8);
        g.drawRect(x - 1, y - 12, 2, 4);
        g.endFill();
        g.beginFill(0xfef08a);
        g.drawPolygon([x - 3, y - 12, x + 3, y - 12, x + 2, y - 16, x - 2, y - 16]);
        g.endFill();
        c.addChild(g);
    ...
    drawLuxuryBed(c, x, y, col) {
        ...
        g.drawRect(x - 30, y - 20, 6, 20);
        g.endFill();
        g.beginFill(0x2a2a42);
        g.drawRect(x - 24, y - 10, 48, 10);
        g.endFill();
        g.beginFill(col);
        g.drawRect(x - 10, y - 12, 34, 8);
        g.endFill();
        g.beginFill(0xffffff);
        g.drawRect(x - 22, y - 14, 8, 5);
        g.drawRect(x - 12, y - 14, 8, 5);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawBossDesk(c, x, y, col) {
        ...
        g.eventMode = 'none';
        g.beginFill(0x1a1a2e);
        g.drawRect(x - 5, y - 18, 50, 18);
        g.endFill();
        g.beginFill(col);
        g.drawRect(x - 8, y - 18, 56, 5);
        g.endFill();
        g.beginFill(0x11111a);
        g.drawRect(x + 10, y - 30, 6, 12);
        g.drawRect(x + 20, y - 30, 6, 12);
        g.endFill();
        g.beginFill(0x22d3ee);
        g.drawRect(x + 9, y - 29, 2, 10);
        g.drawRect(x + 19, y - 29, 2, 10);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawRing(c, x, y) {
        ...
        g.drawRect(x - 40, y - 10, 80, 2);
        g.endFill();
        g.beginFill(0x33334a);
        g.drawRect(x - 40, y - 30, 4, 20);
        g.drawRect(x + 36, y - 30, 4, 20);
        g.endFill();
        g.beginFill(0xef4444);
        g.drawRect(x - 40, y - 25, 80, 2);
        g.endFill();
        g.beginFill(0xffffff);
        g.drawRect(x - 40, y - 15, 80, 2);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawWineRack(c, x, y) {
        ...
        // Wooden rack frame
        g.beginFill(0x78350f);
        g.drawRect(x - 20, y - 45, 40, 45);
        g.endFill();
        g.beginFill(0x92400e);
        g.drawRect(x - 18, y - 43, 36, 41);
        g.endFill();
        // Wine bottles (rows)
        for (let wy = y - 40; wy < y - 5; wy += 8) {
            for (let wx = x - 14; wx < x + 14; wx += 8) {
                g.beginFill(0x4c1d20);
                g.drawRect(wx, wy, 6, 5);
                g.endFill();
                g.beginFill(0x7f1d1d, 0.8);
                g.drawCircle(wx + 3, wy + 2, 2);
                g.endFill();
            }
        }
        c.addChild(g);
    ...
    drawTrophyCase(c, x, y, col) {
        ...
        // Glass case
        g.beginFill(0x1e293b);
        g.drawRect(x - 22, y - 40, 44, 40);
        g.endFill();
        g.beginFill(0x0f172a);
        g.drawRect(x - 20, y - 38, 40, 36);
        g.endFill();
        ...
        g.drawRect(x - 8, y - 28, 4, 14);
        g.drawRect(x - 12, y - 28, 12, 4);
        g.endFill();
        g.beginFill(col || 0xfbbf24);
        g.drawRect(x + 6, y - 22, 4, 10);
        g.drawRect(x + 2, y - 22, 12, 3);
        g.endFill();
        g.beginFill(0xc0c0c0);
        g.drawRect(x - 4, y - 18, 3, 8);
        g.endFill();
        // Glass reflection
        const glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(0x38bdf8, 0.06);
        glow.drawRect(x - 20, y - 38, 40, 36);
        glow.endFill();
        c.addChild(g, glow);
    },
    ...
    drawFireplace(c, x, y) {
        ...
        g.drawRect(x - 30, y - 40, 60, 40);
        g.endFill();
        g.beginFill(0x57534e);
        g.drawRect(x - 32, y - 42, 64, 6);
        g.endFill();
        // Firebox
        g.beginFill(0x1c1917);
        g.drawRect(x - 18, y - 30, 36, 26);
        g.endFill();
        // Flames
        ...
        const glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(0xf97316, 0.08);
        glow.drawCircle(x, y - 15, 40);
        glow.endFill();
        c.addChild(g, glow);
        if (!this.indoorLights) this.indoorLights = [];
    ...
    drawBonsaiTree(c, x, y) {
        ...
        g.endFill();
        g.beginFill(0x92400e);
        g.drawRect(x - 10, y - 10, 20, 4);
        g.endFill();
        // Trunk
        g.beginFill(0x5c4033);
        g.drawRect(x - 2, y - 22, 4, 14);
        g.endFill();
        g.beginFill(0x5c4033);
        g.drawRect(x, y - 24, 8, 3);
        g.endFill();
        // Canopy
        g.beginFill(0x166534);
        g.drawCircle(x - 4, y - 26, 8);
        g.drawCircle(x + 6, y - 24, 6);
        g.drawCircle(x, y - 30, 7);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawScrollArt(c, x, y) {
        ...
        // Hanging scroll
        g.beginFill(0x78350f);
        g.drawRect(x - 12, y - 50, 24, 3);
        g.endFill();
        g.beginFill(0xfef3c7);
        g.drawRect(x - 10, y - 47, 20, 35);
        g.endFill();
        ...
        g.endFill();
        g.beginFill(0xdc2626, 0.8);
        g.drawRect(x + 2, y - 18, 5, 5);
        g.endFill();
        // Bottom rod
        g.beginFill(0x78350f);
        g.drawRect(x - 12, y - 12, 24, 3);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawMMAOctagon(c, x, y) {
        ...
        // Platform
        g.beginFill(0x1a1a2e);
        g.drawRect(x - 50, y - 6, 100, 6);
        g.endFill();
        // Canvas mat
        g.beginFill(0x2d2d4d);
        g.drawRect(x - 45, y - 8, 90, 4);
        g.endFill();
        // Cage posts
        g.beginFill(0x64748b);
        g.drawRect(x - 48, y - 44, 4, 40);
        g.drawRect(x + 44, y - 44, 4, 40);
        g.endFill();
        // Cage mesh (horizontal wires)
        g.lineStyle(1, 0x94a3b8, 0.4);
        for (let wy = y - 40; wy < y - 10; wy += 6) {
            g.moveTo(x - 46, wy);
            g.lineTo(x + 46, wy);
        }
        g.lineStyle(0);
        // Corner pads
        g.beginFill(0xef4444);
        g.drawRect(x - 48, y - 44, 6, 6);
        g.drawRect(x + 42, y - 44, 6, 6);
        g.endFill();
        // "UFC" label on mat
        g.beginFill(0xef4444, 0.3);
        g.drawRect(x - 12, y - 7, 24, 2);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawSurfboard(c, x, y) {
        ...
        // Stripe
        g.beginFill(0xfbbf24);
        g.drawRect(x - 2, y - 45, 4, 30);
        g.endFill();
        // Fin
        g.beginFill(0x0369a1);
        g.drawPolygon([x - 1, y - 6, x + 4, y - 2, x - 1, y - 2]);
        g.endFill();
        // Wall mount brackets
        g.beginFill(0x64748b);
        g.drawRect(x - 8, y - 40, 3, 6);
        g.drawRect(x - 8, y - 20, 3, 6);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawVRHeadsetDisplay(c, x, y) {
        ...
        g.endFill();
        g.beginFill(0x0f172a);
        g.drawRect(x - 8, y - 10, 16, 4);
        g.endFill();
        // VR headset
        g.beginFill(0x334155);
        g.drawRoundedRect(x - 10, y - 22, 20, 12, 3);
        g.endFill();
        g.beginFill(0x0ea5e9, 0.4);
        g.drawRect(x - 8, y - 20, 7, 8);
        g.drawRect(x + 1, y - 20, 7, 8);
        g.endFill();
        // Strap
        ...
        const glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(0x0ea5e9, 0.15);
        glow.drawCircle(x, y - 16, 18);
        glow.endFill();
        glow.blendMode = PIXI.BLEND_MODES.ADD;
        c.addChild(g, glow);
        if (!this.indoorLights) this.indoorLights = [];
    ...
    drawTelescope(c, x, y) {
        ...
        g.beginFill(0x1e293b);
        g.drawPolygon([x - 4, y - 32, x + 20, y - 48, x + 22, y - 44, x - 2, y - 28]);
        g.endFill();
        // Lens
        g.beginFill(0x38bdf8, 0.6);
        g.drawCircle(x + 22, y - 46, 3);
        g.endFill();
        // Eyepiece
        g.beginFill(0x475569);
        g.drawRect(x - 6, y - 34, 4, 4);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawLeatherJacketDisplay(c, x, y, col) {
        ...
        g.drawPolygon([x - 6, y - 44, x, y - 40, x + 6, y - 44, x + 4, y - 46, x, y - 43, x - 4, y - 46]);
        g.endFill();
        // Zipper line
        g.beginFill(0x64748b);
        g.drawRect(x - 1, y - 40, 2, 26);
        g.endFill();
        // Spotlight
        const glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(col || 0xfbbf24, 0.06);
        glow.drawCircle(x, y - 30, 22);
        glow.endFill();
        c.addChild(g, glow);
    },
    ...
    drawMeditationCorner(c, x, y) {
        ...
        g.eventMode = 'none';
        // Tatami/mat
        g.beginFill(0x92400e, 0.4);
        g.drawEllipse(x, y - 2, 22, 6);
        g.endFill();
        // Meditation cushion (zafu)
        g.beginFill(0x7c3aed);
        g.drawEllipse(x, y - 6, 10, 4);
        g.endFill();
        g.beginFill(0x6d28d9);
        g.drawEllipse(x, y - 8, 8, 3);
        g.endFill();
        // Incense holder
        g.beginFill(0x78350f);
        g.drawRect(x + 18, y - 4, 6, 4);
        g.endFill();
        // Smoke wisps
        g.lineStyle(1, 0x94a3b8, 0.3);
        g.moveTo(x + 21, y - 6);
        g.quadraticCurveTo(x + 23, y - 16, x + 19, y - 24);
        g.moveTo(x + 21, y - 6);
        g.quadraticCurveTo(x + 18, y - 14, x + 22, y - 22);
        g.lineStyle(0);
        // Candle
        g.beginFill(0xfef3c7);
        g.drawRect(x - 20, y - 8, 4, 8);
        g.endFill();
        g.beginFill(0xfbbf24);
        g.drawPolygon([x - 20, y - 8, x - 18, y - 14, x - 16, y - 8]);
        g.endFill();
        const glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(0xfbbf24, 0.06);
        glow.drawCircle(x - 18, y - 10, 16);
        glow.endFill();
        c.addChild(g, glow);
        if (!this.indoorLights) this.indoorLights = [];
    ...
    drawRocketModel(c, x, y) {
        ...
        // Pedestal
        g.beginFill(0x1e293b);
        g.drawRect(x - 10, y - 6, 20, 6);
        g.endFill();
        g.beginFill(0x334155);
        g.drawRect(x - 12, y - 8, 24, 4);
        g.endFill();
        // Rocket body
        g.beginFill(0xf1f5f9);
        g.drawRect(x - 4, y - 42, 8, 34);
        g.endFill();
        // Nose cone
        g.beginFill(0xf1f5f9);
        g.drawPolygon([x - 4, y - 42, x, y - 52, x + 4, y - 42]);
        g.endFill();
        // Window
        g.beginFill(0x0ea5e9);
        g.drawCircle(x, y - 36, 2);
        g.endFill();
        // Fins
        g.beginFill(0x64748b);
        ...
        g.endFill();
        // Exhaust glow
        g.beginFill(0xf97316, 0.4);
        g.drawPolygon([x - 3, y - 8, x, y - 2, x + 3, y - 8]);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawCookingStation(c, x, y) {
        ...
        // Counter
        g.beginFill(0x334155);
        g.drawRect(x - 30, y - 16, 60, 16);
        g.endFill();
        g.beginFill(0xf1f5f9);
        g.drawRect(x - 32, y - 16, 64, 3);
        g.endFill();
        // Stove burners
        g.beginFill(0x111111);
        g.drawCircle(x - 12, y - 16, 6);
        g.drawCircle(x + 12, y - 16, 6);
        g.endFill();
        g.beginFill(0xef4444, 0.5);
        g.drawCircle(x - 12, y - 16, 3);
        g.endFill();
        // Pot
        g.beginFill(0x64748b);
        g.drawRect(x + 6, y - 26, 14, 10);
        g.endFill();
        g.beginFill(0x94a3b8);
        g.drawRect(x + 4, y - 26, 18, 2);
        g.endFill();
        // Steam
        g.lineStyle(1, 0xffffff, 0.2);
        g.moveTo(x + 10, y - 28);
        g.quadraticCurveTo(x + 8, y - 36, x + 12, y - 42);
        g.moveTo(x + 16, y - 28);
        g.quadraticCurveTo(x + 18, y - 34, x + 14, y - 40);
        g.lineStyle(0);
        // Hanging utensils
        g.beginFill(0x94a3b8);
        g.drawRect(x - 24, y - 40, 1, 12);
        g.drawRect(x - 20, y - 38, 1, 10);
        g.drawRect(x - 16, y - 42, 1, 14);
        g.endFill();
        // Knife block
        g.beginFill(0x5c3a1e);
        g.drawRect(x + 22, y - 24, 8, 8);
        g.endFill();
        g.beginFill(0x94a3b8);
        g.drawRect(x + 24, y - 30, 1, 8);
        g.drawRect(x + 27, y - 28, 1, 6);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawGPUShowcase(c, x, y, col) {
        ...
        // Glass display case
        g.beginFill(0x0f172a);
        g.drawRect(x - 22, y - 45, 44, 45);
        g.endFill();
        g.lineStyle(1, col || 0x76b900, 0.3);
        g.drawRect(x - 22, y - 45, 44, 45);
        g.lineStyle(0);
        // GPU cards (stacked)
        for (let i = 0; i < 4; i++) {
            const gy2 = y - 38 + i * 9;
            g.beginFill(0x1e293b);
            g.drawRect(x - 16, gy2, 32, 7);
            g.endFill();
            g.beginFill(col || 0x76b900, 0.6);
            g.drawRect(x - 14, gy2 + 1, 8, 5);
            g.endFill();
            // Heat pipes
            g.beginFill(0x64748b);
            g.drawRect(x + 2, gy2 + 2, 12, 1);
            g.drawRect(x + 2, gy2 + 4, 12, 1);
            g.endFill();
            // LED
            g.beginFill(col || 0x76b900);
            g.drawCircle(x + 16, gy2 + 3, 1);
            g.endFill();
        }
        const glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(col || 0x76b900, 0.06);
        glow.drawRect(x - 22, y - 45, 44, 45);
        glow.endFill();
        glow.blendMode = PIXI.BLEND_MODES.ADD;
        c.addChild(g, glow);
        if (!this.indoorLights) this.indoorLights = [];
    ...
    drawGymCorner(c, x, y) {
        ...
        // Bench press
        g.beginFill(0x1e293b);
        g.drawRect(x - 20, y - 8, 40, 4);
        g.endFill(); // bench
        g.beginFill(0x334155);
        g.drawRect(x - 22, y - 4, 4, 4);
        g.drawRect(x + 18, y - 4, 4, 4);
        g.endFill(); // legs
        // Barbell rack
        g.beginFill(0x64748b);
        g.drawRect(x - 24, y - 30, 4, 26);
        g.drawRect(x + 20, y - 30, 4, 26);
        g.endFill();
        // Barbell
        g.beginFill(0x94a3b8);
        g.drawRect(x - 28, y - 28, 56, 2);
        g.endFill();
        // Weight plates
        g.beginFill(0x1e293b);
        g.drawRect(x - 30, y - 32, 6, 10);
        g.drawRect(x + 24, y - 32, 6, 10);
        g.endFill();
        // Dumbbells on floor
        g.beginFill(0x64748b);
        g.drawRect(x + 30, y - 4, 14, 3);
        g.endFill();
        g.beginFill(0x1e293b);
        g.drawRect(x + 28, y - 6, 4, 6);
        g.drawRect(x + 42, y - 6, 4, 6);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawPoolTable(c, x, y) {
        ...
        // Table legs
        g.beginFill(0x5c3a1e);
        g.drawRect(x - 38, y - 4, 4, 4);
        g.drawRect(x + 34, y - 4, 4, 4);
        g.endFill();
        // Table body
        g.beginFill(0x5c3a1e);
        g.drawRect(x - 40, y - 12, 80, 8);
        g.endFill();
        // Green felt
        g.beginFill(0x166534);
        g.drawRect(x - 36, y - 14, 72, 6);
        g.endFill();
        // Rails
        g.beginFill(0x4a2e16);
        g.drawRect(x - 38, y - 16, 76, 2);
        g.endFill();
        // Corner pockets
        g.beginFill(0x000000);
        g.drawCircle(x - 35, y - 13, 2);
        g.drawCircle(x + 35, y - 13, 2);
        g.endFill();
        // Balls
        g.beginFill(0xffffff);
        g.drawCircle(x - 10, y - 12, 1.5);
        g.endFill();
        g.beginFill(0xef4444);
        g.drawCircle(x + 8, y - 11, 1.5);
        g.endFill();
        g.beginFill(0xfbbf24);
        g.drawCircle(x + 12, y - 12, 1.5);
        g.endFill();
        g.beginFill(0x3b82f6);
        g.drawCircle(x + 10, y - 13, 1.5);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawHomeBar(c, x, y) {
        ...
        g.endFill();
        g.beginFill(0x78350f);
        g.drawRect(x - 32, y - 20, 64, 4);
        g.endFill();
        // Back shelf with bottles
        g.beginFill(0x3a2a18);
        g.drawRect(x - 28, y - 48, 56, 28);
        g.endFill();
        ...
        for (let i = 0; i < 4; i++) {
            ...
            g.drawRect(x - 22 + i * 12, y - 26, 4, 6);
            g.endFill();
        }
        // Bar stools
        g.beginFill(0x1e293b);
        g.drawCircle(x - 16, y - 4, 5);
        g.drawCircle(x + 16, y - 4, 5);
        g.endFill();
        g.beginFill(0x334155);
        g.drawRect(x - 17, y - 2, 2, 2);
        g.drawRect(x + 15, y - 2, 2, 2);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawCricketBat(c, x, y) {
        ...
        g.drawRect(x - 4, y - 48, 8, 30);
        g.endFill(); // blade
        g.beginFill(0xc2956b);
        g.drawRect(x - 3, y - 18, 6, 14);
        g.endFill(); // handle
        g.beginFill(0x78350f);
        g.drawRect(x - 2, y - 16, 4, 10);
        g.endFill(); // grip
        // Cricket ball beside it
        g.beginFill(0xdc2626);
        g.drawCircle(x + 14, y - 6, 4);
        g.endFill();
        g.lineStyle(1, 0xfef3c7, 0.6);
        g.moveTo(x + 11, y - 6);
        g.lineTo(x + 17, y - 6);
        g.lineStyle(0);
        // Mount bracket
        g.beginFill(0x64748b);
        g.drawRect(x - 6, y - 40, 2, 6);
        g.drawRect(x - 6, y - 24, 2, 6);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawStandingDesk(c, x, y, col) {
        ...
        // Tall desk frame
        g.beginFill(0x475569);
        g.drawRect(x - 22, y - 2, 4, 2);
        g.drawRect(x + 18, y - 2, 4, 2);
        g.endFill(); // feet
        g.beginFill(0x64748b);
        g.drawRect(x - 20, y - 28, 4, 26);
        g.drawRect(x + 16, y - 28, 4, 26);
        g.endFill(); // legs
        // Desktop
        g.beginFill(0x1e293b);
        g.drawRect(x - 24, y - 30, 48, 4);
        g.endFill();
        // Monitor (tall mounted)
        g.beginFill(0x0f172a);
        g.drawRect(x - 10, y - 46, 20, 14);
        g.endFill();
        g.beginFill(col || 0x22d3ee);
        g.drawRect(x - 8, y - 44, 16, 10);
        g.endFill();
        // Keyboard
        g.beginFill(0x334155);
        g.drawRect(x - 8, y - 28, 16, 2);
        g.endFill();
        const glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(col || 0x22d3ee, 0.15);
        glow.drawRect(x - 8, y - 44, 16, 10);
        glow.endFill();
        glow.blendMode = PIXI.BLEND_MODES.ADD;
        c.addChild(g, glow);
        if (!this.indoorLights) this.indoorLights = [];
    ...
    drawWhiteboard(c, x, y, w) {
        ...
        g.moveTo(x - bw / 2 + 6, y - 34);
        g.lineTo(x - 4, y - 30);
        g.lineTo(x + 10, y - 36);
        g.lineStyle(1, 0xef4444, 0.3);
        g.moveTo(x - 10, y - 22);
        g.lineTo(x + bw / 2 - 8, y - 18);
        g.lineStyle(1, 0x22c55e, 0.3);
        g.moveTo(x - bw / 2 + 8, y - 16);
        g.lineTo(x + 6, y - 20);
        g.lineStyle(0);
        // Tray
        g.beginFill(0x94a3b8);
        g.drawRect(x - bw / 2, y - 10, bw, 3);
        g.endFill();
        // Markers
        g.beginFill(0xef4444);
        g.drawRect(x - 8, y - 12, 6, 2);
        g.endFill();
        g.beginFill(0x3b82f6);
        g.drawRect(x + 2, y - 12, 6, 2);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawIndoorGarden(c, x, y) {
        ...
        g.endFill();
        g.beginFill(0x3a2a18);
        g.drawRect(x - 28, y - 4, 56, 2);
        g.endFill();
        // Soil
        g.beginFill(0x2a1e10);
        g.drawRect(x - 28, y - 8, 56, 4);
        g.endFill();
    ...
    drawSiloInterior(c, x, y, w, floorH, col) {
        ...
        g.drawRect(x, y, w, floorH);
        g.endFill();
        g.beginFill(0x111118);
        g.drawRect(x + 8, y + 8, w - 16, floorH - 16);
        g.endFill();
        // Hazard tape top
        g.beginFill(0xfbbf24);
        ...
        for (var rx = x + 30; rx < x + w - 60; rx += 55) {
            // Rack body
            g.beginFill(0x1e293b);
            g.drawRect(rx, y + 14, 28, floorH - 22);
            g.endFill();
            g.beginFill(0x0f172a);
            g.drawRect(rx + 3, y + 18, 22, floorH - 30);
            g.endFill();
            // Drive bays
            for (var dy = y + 22; dy < y + floorH - 14; dy += 7) {
                g.beginFill(0x334155);
                g.drawRect(rx + 5, dy, 18, 5);
                g.endFill();
                // Status LEDs
                g.beginFill(Math.random() > 0.3 ? 0x4ade80 : 0xef4444);
                g.drawCircle(rx + 8, dy + 2, 1);
                g.endFill();
                g.beginFill(0x06b6d4, 0.6);
                g.drawCircle(rx + 12, dy + 2, 1);
                g.endFill();
            }
        }
        ...
        var coreX = x + w / 2;
        g.beginFill(0x0f172a);
        g.drawRect(coreX - 12, y + 10, 24, floorH - 18);
        g.endFill();
        g.beginFill(col || 0x06b6d4, 0.4);
        g.drawRect(coreX - 8, y + 14, 16, floorH - 26);
        g.endFill();
        // Pulsing core glow
        var glow = new PIXI.Graphics();
        glow.eventMode = 'none';
        glow.beginFill(col || 0x06b6d4, 0.06);
        glow.drawRect(coreX - 30, y + 10, 60, floorH - 18);
        glow.endFill();
        c.addChild(g, glow);
        if (!this.indoorLights) this.indoorLights = [];
        this.indoorLights.push({ g: glow, maxA: 0.1, type: 'screen' });
        // SILO label
        var siloTxt = new PIXI.Text('SECURE SILO', {
            fontFamily: 'Silkscreen',
            fontSize: 7,
            fill: 0xef4444,
            letterSpacing: 2,
        });
        siloTxt.anchor.set(0.5, 0);
        siloTxt.x = x + w / 2;
        siloTxt.y = y + 4;
        c.addChild(siloTxt);
    },
