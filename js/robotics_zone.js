...
const ROBOTICS_COMPANIES = {
    ...
    figure: {
        ...
        milestone:
            'Mar 2026: BotQ hit ONE ROBOT PER HOUR — a 24× throughput jump in under 120 days, 350+ Figure 03s delivered.',
        facts: [
    ...
    boston_dynamics: {
        ...
        milestone:
            "Jul 5, 2026: Atlas delivered the match ball at the FIFA World Cup Round of 16 (Brazil vs. Norway, East Rutherford, NJ) — Hyundai's first live robotics activation before a global audience.",
        facts: [
    ...
    agility: {
        ...
        milestone:
            'Jul 2, 2026: Agility agreed to go public via a $2.5B SPAC merger with Churchill Capital Corp XI (ticker AGLT), backed by a $200M Foxconn-led PIPE.',
        facts: [
    ...
    '1x': {
        ...
        color: '#d9c9a8',
        icon: '🧍',
        hq: 'Palo Alto + Moss, Norway',
        founded: '2014',
        program: 'Humanoid for the HOME — knit-suit NEO',
        milestone:
            '10,000 NEO pre-orders in the first five days; full-scale production started at Hayward, CA in Apr 2026.',
        facts: [
    ...
    apptronik: {
        ...
        milestone:
            'Jun 30, 2026: Apollo 2 unveiled at the expanded Robot Park in Austin — in biped AND wheeled-base versions.',
        facts: [
    ...
    ubtech: {
        ...
        milestone:
            'Jul 2, 2026: Walker S2 went live at the China-Vietnam Fangchenggang border crossing under a ¥264M contract — patrols, cargo inspection, multilingual queue guidance.',
        facts: [
    ...
    BLDS: [
        {
            ...
            emoji: '🏭',
            type: 'robotics',
            desc: "Modeled on Figure's BotQ and Tesla's Fremont line — the 2026 humanoid factories that went from one robot a day to one an hour. Chassis fab, motor integration, AI brain upload, calibration, and a finished-goods hall with all eight flagship humanoids.",
        },
        {
            id: 'robotics_testing',
            name: 'Testing Ground',
            ...
            emoji: '🔬',
            type: 'robotics',
            desc: 'Walk tests, obstacle courses and endurance runs. All eight 2026 flagship humanoids pace the yard here — from Atlas to the kung-fu-trained Unitree G1.',
        },
        {
            id: 'robotics_deploy',
            ...
            emoji: '🚛',
            type: 'robotics',
            desc: "Where the robots clock in for real jobs: GXO warehouses, Hyundai and Mercedes plants, BYD lines — and, since NEO started shipping, people's living rooms.",
        },
        {
            id: 'robotics_rd',
            name: 'R&D Lab',
            ...
            emoji: '🧠',
            type: 'robotics',
            desc: 'Next-gen actuators, sensors and embodied AI. The 2026 frontier: vision-language-action brains like Helix and Gemini Robotics, trained on live factory data.',
        },
    ],

    NPCS: [
        {
            id: 'npc_robo_engineer',
            name: 'Robotics Engineer',
            role: 'System Design',
            workplace: 'robotics_assembly',
            color: '#ec4899',
            shift: 'day',
        },
        {
        ...
        },
        {
            ...
            name: 'Test Engineer',
            role: 'QA Lead',
            workplace: 'robotics_testing',
            color: '#06b6d4',
            shift: 'day',
        },
        {
            id: 'npc_robo_calibrator',
            name: 'Calibration Tech',
            role: 'Sensor Calibration',
            workplace: 'robotics_testing',
            color: '#22d3ee',
            shift: 'day',
        },
        {
            id: 'npc_robo_logistics',
            name: 'Logistics Manager',
            role: 'Shipping Coordinator',
            workplace: 'robotics_deploy',
            color: '#10b981',
            shift: 'day',
        },
        {
            id: 'npc_robo_researcher',
            name: 'AI Researcher',
            role: 'Embodied Intelligence',
            workplace: 'robotics_rd',
            color: '#8b5cf6',
            shift: 'day',
        },
        {
            id: 'npc_robo_intern',
            name: 'Robotics Intern',
