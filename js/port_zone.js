...
const PortZone = {
    COMMODITIES: [
        {
            ...
            unit: 'rack',
            category: 'compute',
            desc: 'Launched at CES Jan 2026 — six new chips, full production, shipping to AWS/Google/Microsoft/OCI in H2 2026.',
        },
        {
            id: 'gpu_b200',
            name: 'NVIDIA B200',
            ...
            unit: 'unit',
            category: 'compute',
            desc: 'Blackwell workhorse for trillion-parameter models — still the volume shipper while Rubin ramps.',
        },
        {
            id: 'gpu_h100',
            ...
            unit: 'unit',
            category: 'compute',
            desc: 'The 2023 legend, now trading second-hand as clusters upgrade to Blackwell and Rubin.',
        },
        {
            id: 'euv_scanner',
            name: 'High-NA EUV (EXE:5200)',
            emoji: '🔬',
            unit: 'machine',
            category: 'fabrication',
            desc: "ASML's $380M lithography monster — ~250 crates per machine. Only ~10 ship worldwide in 2026; Intel & Samsung lead, TSMC waits till 2029.",
        },
        {
            id: 'hbm_memory',
            name: 'HBM4 Memory',
            ...
            unit: 'stack',
            category: 'compute',
            desc: "Mass production began Feb 2026. SK Hynix supplies ~2/3 of NVIDIA's HBM4; a 12-high stack clears $600.",
        },
        {
            id: 'silicon_wafer',
            name: 'N2 Wafers (300mm)',
            emoji: '💿',
            unit: 'wafer',
            category: 'fabrication',
            desc: "TSMC's 2nm node hit volume production Q4 2025 — capacity growing 70%/yr through 2028.",
        },
        {
            id: 'helium',
            name: 'Liquid Helium',
            ...
            unit: 'L',
            category: 'cooling',
            desc: 'Cryogenic coolant for EUV lithography and quantum systems.',
        },
        {
            id: 'rare_earth',
            name: 'Rare Earth (Nd/Ga)',
            emoji: '⛏️',
            unit: 'kg',
            category: 'materials',
            desc: "Neodymium & gallium — China's export-license counter-move in the chip war.",
        },
        {
            id: 'power_xfmr',
            ...
            unit: 'unit',
            category: 'power',
            desc: 'High-voltage transformers — 3-year lead times, the sleeper bottleneck of the DC buildout.',
        },
        {
            id: 'fiber_optic',
            ...
            unit: 'km',
            category: 'network',
            desc: 'Submarine & terrestrial fiber for inter-DC networking.',
        },
        {
            id: 'coolant_sys',
            ...
            unit: 'unit',
            category: 'cooling',
            desc: 'Direct-to-chip liquid cooling — mandatory at Rubin-class rack densities.',
        },
        {
            id: 'server_rack',
            ...
            unit: 'unit',
            category: 'infra',
            desc: 'Open Compute Project rack frames for hyperscale DCs.',
        },
        {
            id: 'copper',
            name: 'Copper (Grade A)',
            ...
            unit: 'tonne',
            category: 'materials',
            desc: 'Essential conductor for power distribution and PCBs.',
        },
        {
            id: 'electricity',
            name: 'Electricity (Ind.)',
            emoji: '🔌',
            unit: 'MWh',
            category: 'power',
            desc: 'Industrial electricity — the largest ongoing cost of AGI.',
        },
    ],
        ...
        const portBlds = [
            {
                ...
                fl: 3,
                emoji: '⚓',
                desc: 'Singularity City harbor master. Tracks every EUV crate, HBM pallet and GPU rack crossing the quay.',
                milestone:
                    'The AI supply chain now moves more value per container than any cargo in maritime history — one EUV shipment outprices a fleet of car carriers.',
                facts: [
            ...
            {
                id: 'port_customs',
                name: 'Export Control Office',
                w: 110,
                fl: 2,
                emoji: '🛃',
                desc: 'Where the chip war gets bureaucratic. Licenses, end-user checks and tariff stamps for every advanced-node shipment.',
                milestone:
                    "Jul 2, 2026: Nvidia's CEO conceded China's AI-chip market to Huawei after booking zero China data-center revenue — the H200 export approval is a dead letter, blocked by Beijing rather than Washington.",
                facts: [
            ...
            },
            {
                ...
                fl: 2,
                emoji: '📦',
                desc: 'Bonded warehouse holding Vera Rubin racks and Blackwell pallets awaiting deployment to the Compute District.',
                milestone:
                    "NVIDIA's Rubin platform went full production after its CES 2026 launch — first racks land at AWS, Google, Microsoft and OCI in H2 2026.",
                facts: [
            ...
            },
            {
                ...
                fl: 1,
                emoji: '🧱',
                desc: 'Stacked steel from Kaohsiung, Busan, Rotterdam and Phoenix. The reach stacker never sleeps.',
                milestone:
                    'Feb 2026: HBM4 mass production began at SK Hynix and Samsung simultaneously — the single most fought-over cargo on this yard.',
                facts: [
            ...
            },
            {
                ...
                fl: 1,
                emoji: '⛽',
                desc: 'Cryogenic helium spheres and diesel reserves. EUV lithography drinks liquid helium; backup gensets drink everything else.',
                milestone:
                    'Helium stays on the critical list — every EUV scanner at every fab needs an unbroken cryogenic supply chain.',
                facts: [
            ...
            },
            {
                ...
                fl: 1,
                emoji: '🏗️',
                desc: 'Ship-to-shore gantry crane. Rated 40 lifts/hour — handled with extreme care when the manifest says lithography.',
                milestone:
                    'The white-glove lift: EUV crates move at half speed, double riggers, zero wind tolerance.',
                facts: [
    ...
    update() {
        ...
        const baseDockX = craneBld
            ? craneBld.x - 20
            : warehouseBld
              ? warehouseBld.x + warehouseBld.w / 2
              : 300;
        ...
        this.ships.forEach((ship, si) => {
            ...
            const canSail =
                !prevShip ||
                prevShip.state === 'docked' ||
                prevShip.state === 'sailing_out' ||
                prevShip.x > ship.dockX + 200;
    ...
    fmtPrice(id) {
        ...
        const val =
            p.price >= 1e6
                ? `$${(p.price / 1e6).toFixed(p.price >= 1e8 ? 0 : 1)}M`
                : p.price >= 10000
