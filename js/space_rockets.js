...
const SpaceRockets = {
    ...
    vehicleName(orgKey) {
        return this.VEHICLES[orgKey] || 'Rocket';
    },
    ...
    draw(g, orgKey, s = 1) {
        ...
        g.drawRect(-4 * s, -45 * s, 8 * s, 45 * s);
        g.endFill();
        g.beginFill(0x94a3b8);
        g.drawPolygon([-4 * s, -45 * s, 0, -58 * s, 4 * s, -45 * s]);
        g.endFill();
    },
    ...
    _spacex(g, s) {
        // Super Heavy booster
        g.beginFill(0xb4bcc4);
        g.drawRect(-6 * s, -42 * s, 12 * s, 42 * s);
        g.endFill();
        g.beginFill(0x9aa3ac);
        g.drawRect(-6 * s, -42 * s, 2.5 * s, 42 * s);
        g.endFill(); // shade
        g.beginFill(0xd9dee3);
        g.drawRect(3 * s, -42 * s, 2 * s, 42 * s);
        g.endFill(); // highlight
        // Grid fins
        ...
        g.beginFill(0xcdd4da);
        g.drawRect(-6 * s, -64 * s, 12 * s, 22 * s);
        g.endFill();
        g.beginFill(0xe3e8ec);
        g.drawRect(3 * s, -64 * s, 2 * s, 22 * s);
        g.endFill();
        // Nose cone
        g.beginFill(0xcdd4da);
        g.drawPolygon([-6 * s, -64 * s, -2 * s, -70 * s, 2 * s, -70 * s, 6 * s, -64 * s]);
        g.endFill();
    ...
    _blue_origin(g, s) {
        ...
        g.drawRect(-5.5 * s, -42 * s, 11 * s, 42 * s);
        g.endFill();
        g.beginFill(0xd8dee5);
        g.drawRect(-5.5 * s, -42 * s, 2 * s, 42 * s);
        g.endFill();
        ...
        // Feather logo band
        g.beginFill(0x0077c8);
        g.drawRect(-5.5 * s, -30 * s, 11 * s, 3 * s);
        g.endFill();
        // Second stage
        g.beginFill(0xf1f5f9);
        g.drawRect(-5.5 * s, -48 * s, 11 * s, 6 * s);
        g.endFill();
        // Bulbous 7m fairing
        ...
        g.endFill();
        g.beginFill(0xdbe3ea);
        g.drawRect(-7.5 * s, -58 * s, 2 * s, 6 * s);
        g.endFill();
        // Blue nose tip
        g.beginFill(0x0077c8);
        g.drawPolygon([-3 * s, -62 * s, 0, -62 * s, 3 * s, -62 * s, 1.5 * s, -62 * s]);
        g.drawRect(-3 * s, -62.5 * s, 6 * s, 1.5 * s);
        g.endFill();
    },
    ...
    _nasa(g, s) {
        ...
        g.endFill();
        // Orange core stage
        g.beginFill(0xd97d43);
        g.drawRect(-4.5 * s, -50 * s, 9 * s, 50 * s);
        g.endFill();
        g.beginFill(0xb96233);
        g.drawRect(-4.5 * s, -50 * s, 2 * s, 50 * s);
        g.endFill();
        g.beginFill(0xeb9a60);
        g.drawRect(2.5 * s, -50 * s, 1.5 * s, 50 * s);
        g.endFill();
        // ICPS upper stage (white)
        g.beginFill(0xf8fafc);
        g.drawRect(-3.5 * s, -58 * s, 7 * s, 8 * s);
        g.endFill();
        // Orion capsule (grey cone)
        g.beginFill(0x9ca3af);
        g.drawPolygon([-3.5 * s, -58 * s, 0, -64 * s, 3.5 * s, -58 * s]);
        g.endFill();
        // Launch Abort System needle
        g.beginFill(0xe5e7eb);
        g.drawRect(-0.8 * s, -70 * s, 1.6 * s, 6 * s);
        g.endFill();
        g.beginFill(0xef4444);
        g.drawRect(-0.8 * s, -70 * s, 1.6 * s, 1.5 * s);
        g.endFill();
    },
    ...
    _cnsa(g, s) {
        ...
        // Core stage
        g.beginFill(0xffffff);
        g.drawRect(-5 * s, -48 * s, 10 * s, 48 * s);
        g.endFill();
        g.beginFill(0xe2e6ea);
        g.drawRect(-5 * s, -48 * s, 2 * s, 48 * s);
        g.endFill();
        // Red CZ bands
        ...
        // PRC flag mark
        g.beginFill(0xde2910);
        g.drawRect(-3.5 * s, -38 * s, 5 * s, 3.5 * s);
        g.endFill();
        g.beginFill(0xffde00);
        g.drawRect(-3 * s, -37.5 * s, 1.2 * s, 1.2 * s);
        g.endFill();
        // Mengzhou capsule fairing
        g.beginFill(0xf1f5f9);
        g.drawPolygon([-5 * s, -48 * s, -3 * s, -56 * s, 3 * s, -56 * s, 5 * s, -48 * s]);
        g.endFill();
        // Escape tower
        g.beginFill(0xcbd5e1);
        g.drawRect(-0.8 * s, -62 * s, 1.6 * s, 6 * s);
        g.endFill();
    },
    ...
    _esa(g, s) {
        ...
        // Core
        g.beginFill(0xffffff);
        g.drawRect(-4 * s, -44 * s, 8 * s, 44 * s);
        g.endFill();
        g.beginFill(0xdde3e8);
        g.drawRect(-4 * s, -44 * s, 1.6 * s, 44 * s);
        g.endFill();
        // ESA blue band + stars hint
        g.beginFill(0x003399);
        g.drawRect(-4 * s, -36 * s, 8 * s, 4 * s);
        g.endFill();
        g.beginFill(0xffcc00);
        g.drawRect(-2.5 * s, -34.8 * s, 1 * s, 1 * s);
        g.drawRect(0.5 * s, -34.8 * s, 1 * s, 1 * s);
        g.endFill();
        // Long fairing
        g.beginFill(0xf8fafc);
        g.drawRect(-4.5 * s, -52 * s, 9 * s, 8 * s);
        g.endFill();
        g.beginFill(0xf8fafc);
        g.drawPolygon([-4.5 * s, -52 * s, 0, -57 * s, 4.5 * s, -52 * s]);
        g.endFill();
    },
    ...
    _ula(g, s) {
        ...
        // Booster stage
        g.beginFill(0xf8fafc);
        g.drawRect(-5 * s, -40 * s, 10 * s, 40 * s);
        g.endFill();
        g.beginFill(0xd7dde3);
        g.drawRect(-5 * s, -40 * s, 2 * s, 40 * s);
        g.endFill();
        ...
        // Centaur V + fairing
        g.beginFill(0xffffff);
        g.drawRect(-6 * s, -52 * s, 12 * s, 12 * s);
        g.endFill();
        g.beginFill(0xe5e9ed);
        g.drawRect(-6 * s, -52 * s, 2 * s, 12 * s);
        g.endFill();
        g.beginFill(0xffffff);
        g.drawPolygon([-6 * s, -52 * s, 0, -58 * s, 6 * s, -52 * s]);
        g.endFill();
        g.beginFill(0x1a1a2e);
        g.drawRect(-6 * s, -41 * s, 12 * s, 1.5 * s);
        g.endFill();
    },

    // ─── Rocket Lab — Electron (carbon-black, the smallsat workhorse) ───
    _rocketlab(g, s) {
        g.beginFill(0x18181b);
        g.drawRect(-3 * s, -42 * s, 6 * s, 42 * s);
        g.endFill();
        g.beginFill(0x3f3f46);
        g.drawRect(1 * s, -42 * s, 1.2 * s, 42 * s);
        g.endFill(); // sheen
        // White ELECTRON band
        g.beginFill(0xf8fafc);
        g.drawRect(-3 * s, -34 * s, 6 * s, 2 * s);
        g.endFill();
        // Rutherford battery band (silver)
        g.beginFill(0x94a3b8);
        g.drawRect(-3 * s, -10 * s, 6 * s, 2 * s);
        g.endFill();
        // Kick-stage separation line
        g.beginFill(0x00b4d8);
        g.drawRect(-3 * s, -38 * s, 6 * s, 1.2 * s);
        g.endFill();
        // Fairing
        g.beginFill(0x18181b);
        g.drawPolygon([-3 * s, -42 * s, 0, -48 * s, 3 * s, -42 * s]);
        g.endFill();
        g.beginFill(0x52525b);
        g.drawPolygon([-1 * s, -44.5 * s, 0, -47 * s, 1 * s, -44.5 * s]);
        g.endFill();
    },
    ...
    _isro(g, s) {
        ...
        g.endFill();
        // Core (L110 + C25)
        g.beginFill(0xfafaf5);
        g.drawRect(-4.5 * s, -46 * s, 9 * s, 46 * s);
        g.endFill();
        g.beginFill(0xe3ded2);
        g.drawRect(-4.5 * s, -46 * s, 1.8 * s, 46 * s);
        g.endFill();
        // Tricolor band
        g.beginFill(0xff6b00);
        g.drawRect(-4.5 * s, -30 * s, 9 * s, 2 * s);
        g.endFill();
        g.beginFill(0xffffff);
        g.drawRect(-4.5 * s, -28 * s, 9 * s, 2 * s);
        g.endFill();
        g.beginFill(0x138808);
        g.drawRect(-4.5 * s, -26 * s, 9 * s, 2 * s);
        g.endFill();
        ...
        // Crew escape spike
        g.beginFill(0xcbd5e1);
        g.drawRect(-0.7 * s, -58 * s, 1.4 * s, 2.5 * s);
        g.endFill();
    },
    ...
    _jaxa(g, s) {
        ...
        g.drawRect(-4.5 * s, -46 * s, 9 * s, 46 * s);
        g.endFill();
        g.beginFill(0xe0e5ea);
        g.drawRect(-4.5 * s, -46 * s, 1.8 * s, 46 * s);
        g.endFill();
        // Orange insulation band (2nd stage tank)
        g.beginFill(0xf59e0b);
        g.drawRect(-4.5 * s, -40 * s, 9 * s, 6 * s);
        g.endFill();
        // JAXA red dot
        g.beginFill(0xdc2626);
        g.drawCircle(0, -22 * s, 1.8 * s);
        g.endFill();
        // Fairing
        g.beginFill(0xf8fafc);
        g.drawRect(-5 * s, -52 * s, 10 * s, 6 * s);
        g.endFill();
        g.beginFill(0xf8fafc);
        g.drawPolygon([-5 * s, -52 * s, 0, -58 * s, 5 * s, -52 * s]);
        g.endFill();
    },
    ...
    _roscosmos(g, s) {
        ...
        g.endFill();
        // Core stage
        g.beginFill(0x9aa38b);
        g.drawRect(-4.5 * s, -40 * s, 9 * s, 40 * s);
        g.endFill();
        g.beginFill(0x7d8670);
        g.drawRect(-4.5 * s, -40 * s, 1.8 * s, 40 * s);
        g.endFill();
        // Orange-brown interstage lattice
        g.beginFill(0xb45309);
        g.drawRect(-4.5 * s, -34 * s, 9 * s, 3 * s);
        g.endFill();
        g.beginFill(0x92400e);
        for (let i = -4; i < 4; i += 2) {
            g.drawRect(i * s, -34 * s, 0.8 * s, 3 * s);
        }
        g.endFill();
        // Payload shroud (crew Soyuz — grey with escape tower)
        g.beginFill(0xd1d5db);
        g.drawRect(-3.5 * s, -50 * s, 7 * s, 10 * s);
        g.endFill();
        g.beginFill(0xd1d5db);
        g.drawPolygon([-3.5 * s, -50 * s, 0, -53 * s, 3.5 * s, -50 * s]);
        g.endFill();
        // Escape tower needle (iconic)
        g.beginFill(0x9ca3af);
        g.drawRect(-0.7 * s, -60 * s, 1.4 * s, 7 * s);
        g.endFill();
        g.beginFill(0x6b7280);
        g.drawRect(-1.4 * s, -55 * s, 2.8 * s, 2 * s);
        g.endFill();
    },
    ...
    _northrop_grumman(g, s) {
        ...
        g.beginFill(0x27272a);
        g.drawRect(-4.5 * s, -24 * s, 9 * s, 24 * s);
        g.endFill();
        g.beginFill(0x3f3f46);
        g.drawRect(2 * s, -24 * s, 1.5 * s, 24 * s);
        g.endFill();
        // Second stage (white Castor 30XL)
        g.beginFill(0xf8fafc);
        g.drawRect(-4.5 * s, -42 * s, 9 * s, 18 * s);
        g.endFill();
        g.beginFill(0xdde2e7);
        g.drawRect(-4.5 * s, -42 * s, 1.8 * s, 18 * s);
        g.endFill();
        // NG blue band
        g.beginFill(0x003d7a);
        g.drawRect(-4.5 * s, -26 * s, 9 * s, 2.5 * s);
        g.endFill();
        ...
        g.endFill();
        g.beginFill(0x94a3b8);
        g.drawRect(-3 * s, -52.8 * s, 6 * s, 1.2 * s);
        g.endFill();
    },
    ...
    _firefly(g, s) {
        g.beginFill(0xf8fafc);
        g.drawRect(-3.5 * s, -40 * s, 7 * s, 40 * s);
        g.endFill();
        g.beginFill(0xdde3e8);
        g.drawRect(-3.5 * s, -40 * s, 1.4 * s, 40 * s);
        g.endFill();
        // Black interstage
        g.beginFill(0x18181b);
        g.drawRect(-3.5 * s, -26 * s, 7 * s, 4 * s);
        g.endFill();
        // Firefly green glow band
        g.beginFill(0xa3e635);
        g.drawRect(-3.5 * s, -14 * s, 7 * s, 1.8 * s);
        g.endFill();
        g.beginFill(0xa3e635);
        g.drawRect(-3.5 * s, -30.8 * s, 7 * s, 1.2 * s);
        g.endFill();
        // Fairing with green tip
        g.beginFill(0xf8fafc);
        g.drawPolygon([-3.5 * s, -40 * s, 0, -47 * s, 3.5 * s, -40 * s]);
        g.endFill();
        g.beginFill(0xa3e635);
        g.drawPolygon([-1.2 * s, -44.5 * s, 0, -47 * s, 1.2 * s, -44.5 * s]);
        g.endFill();
    },
    ...
    _landspace(g, s) {
        ...
        g.beginFill(0xaeb6bd);
        g.drawRect(-5.5 * s, -38 * s, 11 * s, 38 * s);
        g.endFill();
        g.beginFill(0x8d959c);
        g.drawRect(-5.5 * s, -38 * s, 2.2 * s, 38 * s);
        g.endFill();
        g.beginFill(0xcfd6db);
        g.drawRect(2.8 * s, -38 * s, 1.8 * s, 38 * s);
        g.endFill();
        // Grid fins
        g.beginFill(0x52525b);
        ...
        g.endFill();
        // Second stage
        g.beginFill(0xbfc7cd);
        g.drawRect(-5.5 * s, -52 * s, 11 * s, 14 * s);
        g.endFill();
        // Phoenix-red band (Zhuque = Vermilion Bird)
        g.beginFill(0x7f1d1d);
        g.drawRect(-5.5 * s, -44 * s, 11 * s, 3 * s);
        g.endFill();
        g.beginFill(0xdc2626);
        g.drawRect(-5.5 * s, -43.2 * s, 11 * s, 1.4 * s);
        g.endFill();
        // Blunt nose
        g.beginFill(0xbfc7cd);
        g.drawPolygon([-5.5 * s, -52 * s, -2 * s, -58 * s, 2 * s, -58 * s, 5.5 * s, -52 * s]);
        g.endFill();
        g.beginFill(0xdc2626);
        g.drawRect(-2 * s, -58.6 * s, 4 * s, 1.2 * s);
        g.endFill();
    },
};
