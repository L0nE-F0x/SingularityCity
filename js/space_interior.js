...
const SpaceInterior = {
    ...
    ORG_PAD: {
        spacex: {
            showcase: {
                kind: 'sat',
                label: 'AI1 Orbital Data Center',
                sub: '70 m solar wings · 150 kW compute · laser links',
            },
            plaque: [
                '$1.25T xAI merger — Jan 2026',
                'FCC: up to 1M compute sats',
                'Constellation roll-out 2028',
            ],
            npcs0: [
                ['Starship Flight Dir', 0xef4444],
                ['AI1 Payload Eng', null],
            ],
            robot: 'Optimus',
            npcs1: [
                ['Booster Catch Op', null],
                ['Starlink Laser Tech', 0x38bdf8],
            ],
        },
        blue_origin: {
            showcase: {
                kind: 'lander',
                label: 'Blue Moon MK1 "Endurance"',
                sub: 'Passed NASA vacuum-chamber tests',
            },
            plaque: [
                'Nov 2025: booster landed at sea',
                'Apr 2026: first NG reflight',
                'LC-36 rebuild under way',
            ],
            npcs0: [
                ['NG Flight Director', 0xef4444],
                ['BE-4 Engineer', null],
            ],
            npcs1: [
                ['MK1 Lander Tech', null],
                ['Jacklyn Barge Ops', 0x38bdf8],
            ],
        },
        nasa: {
            showcase: {
                kind: 'capsule',
                label: 'Orion Capsule',
                sub: 'Carried the Artemis II crew around the Moon',
            },
            plaque: ['Artemis II: crewed lunar flyby', 'Splashdown Apr 10, 2026', 'Artemis III targets 2027'],
            npcs0: [
                ['Artemis Flight Dir', 0xef4444],
                ['Orion Systems Eng', null],
            ],
            npcs1: [
                ['SLS Booster Eng', null],
                ['EVA Suit Tech', 0x38bdf8],
            ],
        },
        cnsa: {
            showcase: {
                kind: 'capsule',
                label: 'Mengzhou Capsule',
                sub: 'Launch-escape demo flown Feb 2026',
            },
            plaque: [
                'Moon landing before 2030',
                'Shenzhou-23: year-long mission',
                'LM-10 booster recovered at sea',
            ],
            npcs0: [
                ['LM-10 Flight Dir', 0xef4444],
                ['Mengzhou Engineer', null],
            ],
            npcs1: [
                ['Taikonaut Trainer', null],
                ['Lanyue Lander Eng', 0x38bdf8],
            ],
        },
        esa: {
            showcase: {
                kind: 'sat',
                label: 'Amazon Leo Satellite',
                sub: '32 per Ariane 64 — two batches flown in 2026',
            },
            plaque: ['Ariane 64: 4-booster config', '8 launches planned in 2026', 'Next: MTG-I2 (Aug 2026)'],
            npcs0: [
                ['DDO Kourou', 0xef4444],
                ['Range Safety CSG', null],
            ],
            npcs1: [
                ['Leo Constellation Eng', null],
                ['Vega Ops', 0x38bdf8],
            ],
        },
        ula: {
            ...
            plaque: [
                'USSF-87 direct to GEO',
                'Target: 18–22 launches in 2026',
                '100% mission success record',
            ],
            npcs0: [
                ['Vulcan Launch Dir', 0xef4444],
                ['Centaur Fueling', null],
            ],
            npcs1: [
                ['GEM-63XL Tech', null],
                ['GSO Mission Planner', 0x38bdf8],
            ],
        },
        rocketlab: {
            showcase: {
                kind: 'engine',
                label: 'Archimedes Engine',
                sub: 'Methalox engine for reusable Neutron',
            },
            plaque: ['Neutron debut: late 2026', '5-launch Neutron deal signed', 'Electron: 60+ flights'],
            npcs0: [
                ['Neutron Test Lead', 0xef4444],
                ['Electron Recovery', null],
            ],
            npcs1: [
                ['Archimedes Eng', null],
                ['Wallops Range Ops', 0x38bdf8],
            ],
        },
        isro: {
            ...
            npcs0: [
                ['Gaganyaan Flight Dir', 0xef4444],
                ['CE-20 Cryo Engineer', null],
            ],
            robot: 'Vyommitra',
            npcs1: [
                ['Crew Module Tech', null],
                ['Recovery Dive Team', 0x38bdf8],
            ],
        },
        jaxa: {
            showcase: { kind: 'engine', label: 'LE-9 Engine', sub: 'Expander-bleed hydrogen engine for H3' },
            plaque: [
                'SLIM: 100 m precision landing',
                'HTV-X cargo to the ISS',
                'JAXA astronaut on Artemis crew',
            ],
            npcs0: [
                ['H3 Flight Director', 0xef4444],
                ['LE-9 Engineer', null],
            ],
            npcs1: [
                ['HTV-X Cargo Ops', null],
                ['SLIM Nav Engineer', 0x38bdf8],
            ],
        },
        roscosmos: {
            showcase: { kind: 'capsule', label: 'Soyuz MS Capsule', sub: '150+ crewed flights since 1967' },
            plaque: [
                'Longest-serving crew vehicle',
                'Baikonur: oldest spaceport',
                'ROS station planned post-ISS',
            ],
            npcs0: [
                ['Soyuz Flight Dir', 0xef4444],
                ['Kosmodrome Ops', null],
            ],
            npcs1: [
                ['Cosmonaut Trainer', null],
                ['Progress Cargo Ops', 0x38bdf8],
            ],
        },
        northrop_grumman: {
            showcase: { kind: 'sat', label: 'Cygnus Freighter', sub: '60+ tons of ISS cargo delivered' },
            plaque: [
                'Antares 330: new Firefly stage',
                'MEV: first GEO sat servicing',
                'Builds SLS solid boosters',
            ],
            npcs0: [
                ['Antares Launch Dir', 0xef4444],
                ['Cygnus Ops', null],
            ],
            npcs1: [
                ['Solid Motor Eng', null],
                ['MEV Servicing Eng', 0x38bdf8],
            ],
        },
        firefly: {
            showcase: {
                kind: 'lander',
                label: 'Blue Ghost 2 Lander',
                sub: 'Far-side Moon landing, late 2026',
            },
            plaque: ['Blue Ghost 1 landed on Moon', 'VICTUS NOX: 24-hr launch', 'Mission 2: lunar far side'],
            npcs0: [
                ['Alpha Launch Dir', 0xef4444],
                ['Blue Ghost Ops', null],
            ],
            npcs1: [
                ['Elytra Nav Eng', null],
                ['Lunar Payload Eng', 0x38bdf8],
            ],
        },
        landspace: {
            showcase: {
                kind: 'engine',
                label: 'TQ-12A Engine',
                sub: 'Methalox — first type to reach orbit, 2023',
            },
            plaque: [
                'ZQ-3 reached orbit on debut',
                'Landing missed by just 17 s',
                '2026 goal: perfect landing',
            ],
            npcs0: [
                ['ZQ-3 Flight Dir', 0xef4444],
                ['Methalox Prop Eng', null],
            ],
            npcs1: [
                ['Landing Burn Analyst', null],
                ['Recovery Team Lead', 0x38bdf8],
            ],
        },
    },
    ...
    build(bld, layer) {
        ...
        const wallCol = isAssembly
            ? 0x6b7280 // VAB grey-blue
            : isLaunchpad
              ? 0x475569 // dark concrete
              : 0x1e293b; // navy (mission_control / tracking)
        const trimCol = isAssembly
            ? 0xcbd5e1 // light VAB highlight
            : isLaunchpad
              ? 0x64748b // medium concrete
              : 0x334155; // navy trim
        const wallEdge = isAssembly ? 0x4b5563 : isLaunchpad ? 0x334155 : 0x0f172a;
                    ...
                    while (currX < startX + bldW - 120) {
                        ...
                        if (npcCount < 3)
                            this.drawNPC(
                                ...
                                currX + 50,
                                propY,
                                ['GNC', 'Telemetry', 'Propulsion'][npcCount],
                                colHex
                            );
                        currX += 120;
                        npcCount++;
                ...
                if (f === 0) {
                    ...
                    if (pad.plaque && bldW > 420) {
                        this.drawFactPlaque(
                            ...
                            startX + 24,
                            fy + 10,
                            Math.min(215, bldW * 0.3),
                            colHex,
                            org ? org.name : bld.name,
                            pad.plaque
                        );
                    }
                    ...
                    const npcs0 = pad.npcs0 || [
                        ['Launch Dir', 0xef4444],
                        ['Range Safety', 0xfacc15],
                    ];
                    npcs0.forEach((n, i) => {
                        const nx = startX + 150 + i * 170;
                        if (nx < startX + bldW - 100)
                            this.drawNPC(floorCont, nx, propY, n[0], n[1] || colHex);
                    });
        ...
        const paintFlank = (fx, fw) => {
            ...
            sand.beginFill(0xc2956a);
            sand.drawRect(fx, groundY - 18, fw, 18);
            sand.endFill();
            sand.beginFill(0xd4a574);
            sand.drawRect(fx, groundY - 18, fw, 9);
            sand.endFill();
            sand.beginFill(0xe0b88a);
            sand.drawRect(fx, groundY - 18, fw, 2);
            sand.endFill();
            // Compacted sand road (top 28px below ground line)
            sand.beginFill(0x8b7355);
            sand.drawRect(fx, groundY, fw, Math.min(28, flankH));
            sand.endFill();
            sand.beginFill(0x9a8265);
            sand.drawRect(fx, groundY, fw, Math.min(14, flankH));
            sand.endFill();
            // Below the road — packed dirt fading into the upper sandstone of the underground
            if (flankH > 28) {
                sand.beginFill(0x6b4423);
                sand.drawRect(fx, groundY + 28, fw, flankH - 28);
                sand.endFill();
                sand.beginFill(0x5c3a1e);
                sand.drawRect(fx, groundY + 28, fw, Math.min(8, flankH - 28));
                sand.endFill();
            }
        };
        paintFlank(0, leftW);
        ...
        for (let mx = 0; mx < G.vpW; mx += 40) {
            if (mx + 20 < startX || mx > startX + bldW) {
                sand.beginFill(0xd4a574, 0.4);
                sand.drawRect(mx, groundY + 12, 20, 3);
                sand.endFill();
            }
        }
    ...
    drawBigScreen(c, cx, y, w, h, col) {
        ...
        for (let gy = y + 15; gy < y + h; gy += 20) {
            g.moveTo(cx - w / 2 + 4, gy);
            g.lineTo(cx + w / 2 - 4, gy);
        }
        g.lineStyle(0);
        // Earth circle
        ...
        [0x22d3ee, 0xfbbf24, 0x4ade80].forEach((dotCol, i) => {
            ...
            g.beginFill(dotCol);
            g.drawCircle(cx + Math.cos(angle) * rx, y + h / 2 + Math.sin(angle) * ry, 2);
            g.endFill();
        });
        // Glow
        const glow = new PIXI.Graphics();
        glow.beginFill(col, 0.05);
        glow.drawRect(cx - w / 2, y, w, h);
        glow.endFill();
    ...
    drawOperatorDesk(c, x, y, col) {
        ...
        g.drawRect(x, y - 20, 80, 4);
        g.endFill();
        // Triple monitors
        for (let mx = 0; mx < 3; mx++) {
            const sx = x + 5 + mx * 26;
            g.beginFill(0x111118);
            g.drawRect(sx, y - 38, 22, 16);
            g.endFill();
            const screenGlow = new PIXI.Graphics();
            screenGlow.beginFill(col, 0.5);
            screenGlow.drawRect(sx + 1, y - 37, 20, 14);
            screenGlow.endFill();
        ...
        g.drawRect(x + 30, y - 6, 16, 6);
        g.endFill();
        g.beginFill(0x1e293b);
        g.drawRect(x + 36, y - 14, 4, 8);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawCommRack(c, x, y, col) {
        ...
        g.eventMode = 'none';
        g.beginFill(0x111118);
        g.drawRect(x, y - 50, 30, 50);
        g.endFill();
        g.beginFill(0x1a1a2e);
        g.drawRect(x + 2, y - 48, 26, 46);
        g.endFill();
        // LEDs
        for (let ly = y - 45; ly < y - 5; ly += 8) {
            const ledCol = Math.random() > 0.3 ? 0x4ade80 : 0xef4444;
            g.beginFill(ledCol);
            g.drawCircle(x + 8, ly, 1.5);
            g.endFill();
            g.beginFill(col, 0.3);
            g.drawRect(x + 14, ly - 2, 12, 4);
            g.endFill();
        }
        c.addChild(g);
    },
    ...
    drawServerCabinet(c, x, y, col) {
        ...
        g.drawRect(x, y - 55, 40, 55);
        g.endFill();
        g.beginFill(0x111120);
        g.drawRect(x + 3, y - 52, 34, 49);
        g.endFill();
        // Server units
        for (let sy = y - 50; sy < y - 5; sy += 10) {
            g.beginFill(0x1a1a30);
            g.drawRect(x + 5, sy, 30, 8);
            g.endFill();
            g.beginFill(0x4ade80);
            g.drawCircle(x + 10, sy + 4, 1);
            g.endFill();
            g.beginFill(col, 0.2);
            g.drawRect(x + 14, sy + 2, 18, 4);
            g.endFill();
        }
        const glow = new PIXI.Graphics();
        glow.beginFill(col, 0.06);
        glow.drawRect(x, y - 55, 40, 55);
        glow.endFill();
        glow.blendMode = PIXI.BLEND_MODES.ADD;
        c.addChild(g, glow);
    ...
    drawCoffeeMachine(c, x, y) {
        ...
        g.drawRect(x, y - 25, 18, 25);
        g.endFill();
        g.beginFill(0x78350f);
        g.drawRect(x + 4, y - 8, 10, 8);
        g.endFill();
        g.beginFill(0x4ade80);
        g.drawCircle(x + 9, y - 18, 2);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawOverheadCrane(c, cx, y, w) {
        ...
        g.drawRect(cx - w / 2, y, w, 4);
        g.endFill();
        // Trolley
        g.beginFill(0x475569);
        g.drawRect(cx - 15, y + 4, 30, 12);
        g.endFill();
        // Hook cable
        g.beginFill(0x94a3b8);
        g.drawRect(cx - 1, y + 16, 2, 30);
        g.endFill();
        // Hook
        g.lineStyle(2, 0xfacc15);
        g.arc(cx, y + 48, 6, 0, Math.PI);
        g.lineStyle(0);
        c.addChild(g);
    },
    ...
    drawRocketBay(c, cx, y, col) {
        ...
        g.drawRect(cx - 60, y - 20, 120, 16);
        g.endFill();
        g.beginFill(col);
        g.drawPolygon([cx + 60, y - 20, cx + 76, y - 12, cx + 60, y - 4]);
        g.endFill();
        g.beginFill(col);
        g.drawRect(cx - 20, y - 18, 30, 12);
        g.endFill();
        // Support cradle
        g.beginFill(0x475569);
        g.drawRect(cx - 50, y - 4, 20, 4);
        g.drawRect(cx + 30, y - 4, 20, 4);
        g.endFill();
        g.beginFill(0x334155);
        g.drawRect(cx - 45, y - 8, 4, 8);
        g.drawRect(cx + 41, y - 8, 4, 8);
        g.endFill();
        // Floor markings
        g.beginFill(0xfacc15, 0.3);
        for (let mx = cx - 80; mx < cx + 80; mx += 20) {
            g.drawRect(mx, y - 2, 10, 2);
        }
        g.endFill();
        c.addChild(g);
    },
    ...
    drawCleanRoom(c, x, y, w, h) {
        ...
        g.drawRect(x, y + h / 2 - 15, 4, 30);
        g.drawRect(x + w - 4, y + h / 2 - 15, 4, 30);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawPayloadRack(c, x, y, col) {
        ...
        g.endFill();
        g.beginFill(col, 0.2);
        g.drawRect(x + 18, y - 25, 14, 12);
        g.endFill();
        // Status LED
        g.beginFill(0x4ade80);
        g.drawCircle(x + 45, y - 4, 2);
        g.endFill();
        c.addChild(g);
    },
    ...
    drawOrbitalDisplay(c, cx, y, w, h) {
        ...
        g.endFill();
        g.beginFill(0x0a1628);
        g.drawRect(cx - w / 2 + 3, y + 3, w - 6, h - 6);
        g.endFill();
        // Polar grid
    ...
    drawTrackingConsole(c, x, y, col) {
        ...
        // Console desk
        g.beginFill(0x1a1a2e);
        g.drawRect(x, y - 16, 100, 16);
        g.endFill();
        // Dual screens
        g.beginFill(0x111118);
        g.drawRect(x + 5, y - 36, 40, 18);
        g.endFill();
        g.beginFill(0x111118);
        g.drawRect(x + 50, y - 36, 40, 18);
        g.endFill();
    ...
    drawLaunchConsole(c, x, y, col) {
        ...
        // Wide console
        g.beginFill(0x1a1a2e);
        g.drawRect(x, y - 20, 120, 20);
        g.endFill();
        g.beginFill(0x222240);
        g.drawRect(x, y - 22, 120, 4);
        g.endFill();
        // Main screen
        g.beginFill(0x111118);
        g.drawRect(x + 10, y - 42, 60, 18);
        g.endFill();
        const screenGlow = new PIXI.Graphics();
        screenGlow.beginFill(col, 0.4);
        screenGlow.drawRect(x + 11, y - 41, 58, 16);
        screenGlow.endFill();
        screenGlow.blendMode = PIXI.BLEND_MODES.ADD;
        // Status panel
        g.beginFill(0x111118);
        g.drawRect(x + 80, y - 42, 30, 18);
        g.endFill();
        // GO/NO-GO lights
        ...
        g.drawCircle(x + 95, y - 6, 6);
        g.endFill();
        g.beginFill(0xb91c1c);
        g.drawCircle(x + 95, y - 6, 4);
        g.endFill();
    ...
    drawCountdownClock(c, cx, y, bld) {
        ...
        g.eventMode = 'none';
        g.beginFill(0x0a0a12);
        g.drawRect(cx - 50, y, 100, 30);
        g.endFill();
        g.beginFill(0x111120);
        g.drawRect(cx - 48, y + 2, 96, 26);
        g.endFill();
    ...
    _drawShowcase(c, sc, x, y, col) {
        const fn = {
            sat: 'drawSatelliteShowcase',
            lander: 'drawLanderShowcase',
            engine: 'drawEngineShowcase',
            capsule: 'drawCapsuleShowcase',
        }[sc.kind];
    ...
    _showcaseStand(g, cx, y, w) {
        ...
        g.beginFill(0xfacc15, 0.06);
        g.drawEllipse(cx, y - 2, w * 0.8, 5);
        g.endFill();
        g.beginFill(0x1a1a2e);
        g.drawRect(cx - w / 2, y - 6, w, 6);
        g.endFill();
        g.beginFill(0x334155);
        g.drawRect(cx - w / 2, y - 7, w, 2);
        g.endFill();
    },
    ...
    drawSatelliteShowcase(c, x, y, col, label, sub) {
        ...
        // Support pylon
        g.beginFill(0x475569);
        g.drawRect(cx - 2, y - 26, 4, 20);
        g.endFill();
        // Satellite bus (silver box)
        g.beginFill(0xcbd5e1);
        g.drawRect(cx - 9, y - 40, 18, 14);
        g.endFill();
        g.beginFill(0x94a3b8);
        g.drawRect(cx - 9, y - 40, 18, 3);
        g.endFill();
        ...
        g.drawCircle(cx - 6, y - 42, 1.5);
        g.endFill();
        const laser = new PIXI.Graphics();
        laser.beginFill(0x22d3ee);
        laser.drawCircle(cx + 6, y - 42, 1.5);
        laser.endFill();
        laser.blendMode = PIXI.BLEND_MODES.ADD;
        // Dish
        g.beginFill(0xf1f5f9);
        g.drawPolygon([cx - 4, y - 40, cx, y - 46, cx + 4, y - 40]);
        g.endFill();
        sc.addChild(g, laser);
    ...
    drawLanderShowcase(c, x, y, col, label, sub) {
        ...
        g.drawRect(cx - 20, y - 8, 7, 2);
        g.drawRect(cx + 13, y - 8, 7, 2);
        g.endFill();
        // Descent engine bell
        g.beginFill(0x52525b);
        g.drawPolygon([cx - 3, y - 24, cx - 5, y - 16, cx + 5, y - 16, cx + 3, y - 24]);
        g.endFill();
        // Body — gold multi-layer insulation
        g.beginFill(0xca8a04);
        g.drawRect(cx - 12, y - 42, 24, 18);
        g.endFill();
        g.beginFill(0xfbbf24, 0.55);
        g.drawRect(cx - 12, y - 42, 24, 3);
        g.drawRect(cx - 12, y - 34, 24, 2);
        g.endFill();
        // Tank domes
        g.beginFill(0xe5e7eb);
        g.drawCircle(cx - 6, y - 45, 4);
        g.drawCircle(cx + 6, y - 45, 4);
        g.endFill();
        // Org-color logo band
        g.beginFill(col);
        g.drawRect(cx - 12, y - 30, 24, 2.5);
        g.endFill();
        // Antenna
        g.beginFill(0xcbd5e1);
        g.drawRect(cx - 0.7, y - 54, 1.4, 6);
        g.drawCircle(cx, y - 55, 1.5);
        g.endFill();
        sc.addChild(g);
        this._showcaseLabel(sc, cx, y, label);
        c.addChild(sc);
    ...
    drawEngineShowcase(c, x, y, col, label, sub) {
        ...
        // Test-stand A-frame
        g.beginFill(0xfacc15);
        g.drawRect(cx - 22, y - 48, 3, 42);
        g.drawRect(cx + 19, y - 48, 3, 42);
        g.drawRect(cx - 22, y - 48, 44, 3);
        g.endFill();
        // Powerhead + turbopumps
        g.beginFill(0x374151);
        g.drawRect(cx - 7, y - 45, 14, 8);
        g.endFill();
        g.beginFill(0x6b7280);
        g.drawCircle(cx - 8, y - 41, 3.5);
        g.drawCircle(cx + 8, y - 41, 3.5);
        g.endFill();
        // Nozzle bell (copper-lined)
        g.beginFill(0x78350f);
        g.drawPolygon([cx - 5, y - 37, cx - 12, y - 14, cx + 12, y - 14, cx + 5, y - 37]);
        g.endFill();
        g.beginFill(0xb45309);
        g.drawPolygon([cx - 4, y - 36, cx - 10, y - 15, cx - 5, y - 15, cx - 1, y - 36]);
        g.endFill();
        // Cooling channels
        g.lineStyle(1, 0xd97706, 0.4);
        for (let ly = y - 33; ly < y - 16; ly += 4) {
            const t = (y - 14 - ly) / 23;
            g.moveTo(cx - 5 - (1 - t) * 7, ly);
            g.lineTo(cx + 5 + (1 - t) * 7, ly);
        }
        g.lineStyle(0);
        // Propellant feed lines
        g.beginFill(0x0369a1);
        g.drawRect(cx - 20, y - 43, 13, 2.5);
        g.endFill();
        g.beginFill(0xb45309);
        g.drawRect(cx + 7, y - 43, 13, 2.5);
        g.endFill();
        sc.addChild(g);
        this._showcaseLabel(sc, cx, y, label);
        c.addChild(sc);
    ...
    drawCapsuleShowcase(c, x, y, col, label, sub) {
        ...
        // Cradle
        g.beginFill(0x475569);
        g.drawRect(cx - 14, y - 10, 5, 4);
        g.drawRect(cx + 9, y - 10, 5, 4);
        g.endFill();
        // Heat shield (ablative brown)
        g.beginFill(0x7c2d12);
        g.drawEllipse(cx, y - 12, 15, 4);
        g.endFill();
        ...
        // Org accent stripe
        g.beginFill(col);
        g.drawPolygon([cx - 13, y - 18, cx - 12, y - 21, cx + 12, y - 21, cx + 13, y - 18]);
        g.endFill();
        // Windows
        g.beginFill(0x0ea5e9, 0.8);
        g.drawCircle(cx - 3, y - 27, 2);
        g.drawCircle(cx + 4, y - 27, 2);
        g.endFill();
        // Docking hatch on top
        g.beginFill(0x6b7280);
        g.drawRect(cx - 4, y - 40, 8, 4);
        g.endFill();
        g.beginFill(0x9ca3af);
        g.drawRect(cx - 2.5, y - 42, 5, 2);
        g.endFill();
        sc.addChild(g);
        this._showcaseLabel(sc, cx, y, label);
        c.addChild(sc);
    ...
    drawFactPlaque(c, x, y, w, col, title, lines) {
        ...
        c.addChild(sc);
        if (typeof UI !== 'undefined' && UI.tip)
            UI.tip(sc, 'Milestone Plaque', 'Real 2026 headlines for this org');
    },
    ...
    drawMissionPatchWall(c, x, y, col) {
        ...
        for (let i = 0; i < 6; i++) {
            const px = x + 16 + (i % 3) * 28,
                py = y + 14 + Math.floor(i / 3) * 22;
            g.beginFill(0x1f2937);
            g.drawCircle(px, py, 8);
            g.endFill();
            g.lineStyle(1.5, patchCols[i], 0.9);
            g.drawCircle(px, py, 8);
            g.lineStyle(0);
            g.beginFill(patchCols[i], 0.7);
            if (i % 3 === 0)
                g.drawPolygon([px, py - 4, px + 3, py + 3, px - 3, py + 3]); // rocket tri
            else if (i % 3 === 1)
                g.drawCircle(px, py, 2.5); // planet
            else {
                g.drawRect(px - 3.5, py - 0.8, 7, 1.6);
                g.drawRect(px - 0.8, py - 3.5, 1.6, 7);
            } // star cross
            g.endFill();
        }
        sc.addChild(g);
        c.addChild(sc);
        if (typeof UI !== 'undefined' && UI.tip)
            UI.tip(sc, 'Mission Patch Wall', 'One patch per flown mission');
    },
    ...
    drawRobotNPC(c, x, y, name) {
        ...
        head.beginFill(0xd1d5db);
        head.drawRoundedRect(-bw * 0.4, 0, bw * 0.8, headH, 2);
        head.endFill();
        head.beginFill(0x111827);
        head.drawRect(-bw * 0.32, headH * 0.28, bw * 0.64, headH * 0.32);
        head.endFill();
        head.beginFill(0x22d3ee);
        head.drawRect(-bw * 0.24, headH * 0.36, bw * 0.2, headH * 0.16);
        head.drawRect(bw * 0.06, headH * 0.36, bw * 0.2, headH * 0.16);
        head.endFill();
        head.y = -h;

        // Torso — panelled metal with power core
        const body = new PIXI.Graphics();
        body.beginFill(0x9ca3af);
        body.drawRoundedRect(-bw / 2, 0, bw, h - headH - 4, 1.5);
        body.endFill();
        body.beginFill(0x6b7280);
        body.drawRect(-bw / 2, (h - headH - 4) * 0.45, bw, 1.5);
        body.endFill();
        body.beginFill(0x22d3ee, 0.9);
        body.drawCircle(0, (h - headH - 4) * 0.3, 1.8);
        body.endFill();
        body.y = -h + headH;
        ...
        legL.beginFill(0x4b5563);
        legL.drawRect(-lw / 2, 0, lw, 4);
        legL.endFill();
        legL.x = -bw * 0.15;
        const legR = new PIXI.Graphics();
        legR.beginFill(0x4b5563);
        legR.drawRect(-lw / 2, 0, lw, 4);
        legR.endFill();
        legR.x = bw * 0.15;

        const dot = new PIXI.Graphics();
        dot.beginFill(0x22d3ee);
    ...
    updateObservationWindows() {
        ...
        for (const ow of this.observationWindows) {
            ...
            if (r.launchData && (state === 'idle' || state === 'preparation' || state === 'countdown')) {
                ...
                label = `T+${Math.floor((r.timer || 0) / 60)}s`;
                color = 0x4ade80;
            } else if (state === 'orbit') {
                label = 'ORBIT';
                color = 0x4ade80;
    ...
    _drawBasementProps(c, bld, startX, bldW, fy, floorH, colHex) {
        ...
        const labelTxt =
            bld.type === 'launchpad'
                ? 'B1 · FLAME TRENCH & FUEL LINES'
                : bld.type === 'mission_control'
                  ? 'B1 · BACKUP POWER & COOLING'
                  : bld.type === 'assembly'
                    ? 'B1 · TRANSPORTER CRAWLER BAY'
                    : bld.type === 'tracking'
                      ? 'B1 · COOLED SIGNAL VAULT'
                      : 'B1 · SUB-LEVEL';
        ...
        if (bld.type === 'launchpad') {
            ...
            for (let vx = startX + 60; vx < startX + bldW - 40; vx += 200) {
                g.beginFill(0x334155);
                g.drawRect(vx, fy + 26, 12, 12);
                g.endFill();
                g.beginFill(0xef4444);
                g.drawCircle(vx + 6, fy + 32, 2);
                g.endFill();
            }
        } else if (bld.type === 'mission_control') {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                // Generator
                g.beginFill(0x334155);
                g.drawRect(gx, fy + 24, 60, 36);
                g.endFill();
                g.beginFill(0x1f2937);
                g.drawRect(gx + 4, fy + 28, 52, 28);
                g.endFill();
                // Vents
                for (let vy = fy + 32; vy < fy + 55; vy += 4) {
                    g.beginFill(0x0f172a);
                    g.drawRect(gx + 8, vy, 44, 2);
                    g.endFill();
                }
                // Status LED
                g.beginFill(0x4ade80);
                g.drawCircle(gx + 56, fy + 28, 2);
                g.endFill();
            }
            // Cooling pipe overhead
            g.beginFill(0x0369a1);
            g.drawRect(startX + 20, fy + 12, bldW - 40, 6);
            g.endFill();
            g.beginFill(0x0284c7);
            g.drawRect(startX + 20, fy + 13, bldW - 40, 3);
            g.endFill();
        } else if (bld.type === 'assembly') {
            // Crawler transporter — wide tracked vehicle
            const cx = startX + bldW / 2;
            g.beginFill(0x4b5563);
            g.drawRect(cx - 140, fy + 30, 280, 26);
            g.endFill();
            g.beginFill(0x374151);
            g.drawRect(cx - 130, fy + 35, 260, 16);
            g.endFill();
            // Tracks (wheel rows)
            for (let trx = cx - 130; trx < cx + 130; trx += 18) {
                g.beginFill(0x1f2937);
                g.drawCircle(trx, fy + 56, 5);
                g.endFill();
                g.beginFill(0x0a0f1a);
                g.drawCircle(trx, fy + 56, 2);
                g.endFill();
            }
            // Top platform (where rocket would sit)
            g.beginFill(0x6b7280);
            g.drawRect(cx - 100, fy + 22, 200, 8);
            g.endFill();
            g.beginFill(0xfbbf24);
            g.drawRect(cx - 100, fy + 22, 200, 1);
            g.endFill();
            ...
            for (let i = 0; i < 4; i++) {
                ...
                // Server rack
                g.beginFill(0x0a0a12);
                g.drawRect(rx, fy + 14, 50, 50);
                g.endFill();
                g.beginFill(0x111120);
                g.drawRect(rx + 3, fy + 17, 44, 44);
                g.endFill();
                for (let sy = fy + 20; sy < fy + 60; sy += 7) {
                    g.beginFill(0x1a1a30);
                    g.drawRect(rx + 6, sy, 38, 5);
                    g.endFill();
                    g.beginFill(0x4ade80);
                    g.drawCircle(rx + 10, sy + 2.5, 0.8);
                    g.endFill();
                    g.beginFill(colHex, 0.25);
                    g.drawRect(rx + 14, sy + 1, 26, 3);
                    g.endFill();
                }
                // LN2 tank beside rack
                g.beginFill(0xcbd5e1);
                g.drawRect(rx + 56, fy + 24, 20, 38);
                g.endFill();
                g.beginFill(0x94a3b8);
                g.drawRect(rx + 58, fy + 26, 16, 34);
                g.endFill();
                g.beginFill(0x22d3ee, 0.4);
                g.drawRect(rx + 60, fy + 28, 12, 10);
                g.endFill();
                // Frost wisps
                g.beginFill(0xffffff, 0.2);
                g.drawCircle(rx + 66, fy + 22, 3);
                g.endFill();
            }
            // Cold pipe along ceiling
            g.beginFill(0x22d3ee, 0.3);
            g.drawRect(startX + 20, fy + 8, bldW - 40, 4);
            g.endFill();
        }
    ...
    updateAvatars() {
        ...
        const ROBOT_MSGS = [
            'Beep. All systems nominal.',
            'Torque check complete.',
            'Recharging at 87%.',
            'Human detected. Hello.',
            'Running gait diagnostics.',
            'Payload secured. Beep.',
        ];
