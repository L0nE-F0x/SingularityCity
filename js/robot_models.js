...
const RobotModels = {
    ...
    robotName(key) {
        return this.ROBOTS[key] || 'Humanoid';
    },
    ...
    draw(g, key, s = 1) {
        ...
        g.beginFill(0xc0c0d0);
        g.drawRect(-3 * s, -28 * s, 6 * s, 6 * s);
        g.endFill();
        g.beginFill(0x8890a0);
        g.drawRect(-4 * s, -22 * s, 8 * s, 12 * s);
        g.endFill();
        g.beginFill(0x607080);
        g.drawRect(-3 * s, -10 * s, 2.5 * s, 10 * s);
        g.drawRect(0.5 * s, -10 * s, 2.5 * s, 10 * s);
        g.endFill();
    },
    ...
    _tesla(g, s) {
        ...
        // Pelvis
        g.beginFill(0x17181a);
        g.drawRect(-3.6 * s, -14 * s, 7.2 * s, 2.4 * s);
        g.endFill();
        // Torso — sculpted white chest, black waist seam
        g.beginFill(0xe8eaed);
        g.drawRoundedRect(-4.6 * s, -25 * s, 9.2 * s, 11 * s, 2 * s);
        g.endFill();
        g.beginFill(0xc9ccd1);
        g.drawRect(-4.6 * s, -18 * s, 9.2 * s, 1.4 * s);
        g.endFill();
        g.beginFill(0xc9ccd1);
        g.drawRect(-1 * s, -24 * s, 2 * s, 8 * s);
        g.endFill(); // chest seam
        ...
        g.beginFill(0xe8eaed);
        g.drawRoundedRect(-3 * s, -32 * s, 6 * s, 6.4 * s, 2 * s);
        g.endFill();
        g.beginFill(0x0b0c0e);
        g.drawRoundedRect(-2.3 * s, -31.2 * s, 4.6 * s, 4.8 * s, 1.6 * s);
        g.endFill();
        g.beginFill(0x2f3237, 0.9);
        g.drawRect(-1.6 * s, -30.6 * s, 1.4 * s, 1 * s);
        g.endFill(); // gloss
    },
    ...
    _figure(g, s) {
        ...
        g.drawRoundedRect(-4.8 * s, -24 * s, 9.6 * s, 12 * s, 3.5 * s);
        g.endFill();
        g.beginFill(0xc4c8cc);
        g.drawRoundedRect(-3.4 * s, -23 * s, 6.8 * s, 6 * s, 2.5 * s);
        g.endFill();
        ...
        g.beginFill(0xb0b5ba);
        g.drawRoundedRect(-3 * s, -31 * s, 6 * s, 6.6 * s, 2.6 * s);
        g.endFill();
        g.beginFill(0x101214);
        g.drawRoundedRect(-2.4 * s, -30.2 * s, 4.8 * s, 5 * s, 2 * s);
        g.endFill();
        // Camera dot
        g.beginFill(0x60a5fa, 0.9);
        g.drawCircle(0, -28 * s, 0.7 * s);
        g.endFill();
    },
    ...
    _boston_dynamics(g, s) {
        ...
        g.beginFill(0xf1f3f4);
        g.drawRoundedRect(-5.4 * s, -26 * s, 10.8 * s, 11.6 * s, 2.5 * s);
        g.endFill();
        g.beginFill(0x3c4043);
        g.drawRect(-2 * s, -21 * s, 4 * s, 6 * s);
        g.endFill();
    ...
    _agility(g, s) {
        ...
        g.beginFill(0xf4f6f7);
        g.drawRoundedRect(-4.6 * s, -25 * s, 9.2 * s, 12.4 * s, 2 * s);
        g.endFill();
        ...
        g.drawRoundedRect(-3.4 * s, -30 * s, 6.8 * s, 4.4 * s, 1.4 * s);
        g.endFill();
    ...
    _k1x(g, s) {
        ...
        g.drawRoundedRect(-4.4 * s, -23 * s, 8.8 * s, 11 * s, 3.5 * s);
        g.endFill();
        g.beginFill(0xd9c9a8, 0.8);
        g.drawRect(-4.4 * s, -17 * s, 8.8 * s, 1 * s);
        g.endFill();
        // Soft arms
        g.beginFill(0xe8dcc0);
        ...
        g.beginFill(0xe8dcc0);
        g.drawCircle(0, -26.5 * s, 3 * s);
        g.endFill();
        g.beginFill(0x8f959b);
        g.drawRoundedRect(-2 * s, -28 * s, 4 * s, 3.6 * s, 1.6 * s);
        g.endFill();
        g.beginFill(0xffffff, 0.35);
        g.drawCircle(-0.9 * s, -26.6 * s, 0.5 * s);
        g.drawCircle(0.9 * s, -26.6 * s, 0.5 * s);
        g.endFill();
    },
    ...
    _apptronik(g, s) {
        ...
        g.beginFill(0x1f2937);
        g.drawRect(-4 * s, -16 * s, 8 * s, 4 * s);
        g.endFill(); // dark waist
        g.beginFill(0xf5f6f7);
        g.drawRoundedRect(-4.8 * s, -24.5 * s, 9.6 * s, 9.5 * s, 2.5 * s);
        g.endFill();
        g.beginFill(0xdadde0);
        g.drawRect(-4.8 * s, -20 * s, 9.6 * s, 1.2 * s);
        g.endFill();
        // Arms
        g.beginFill(0xf5f6f7);
        ...
        g.beginFill(0xf5f6f7);
        g.drawRoundedRect(-3.1 * s, -31 * s, 6.2 * s, 6.6 * s, 2.2 * s);
        g.endFill();
        g.beginFill(0x111827);
        g.drawRoundedRect(-2.4 * s, -30 * s, 4.8 * s, 4.2 * s, 1.6 * s);
        g.endFill();
    ...
    _unitree(g, s) {
        ...
        g.beginFill(0x1f2937);
        g.drawRoundedRect(-4 * s, -19.5 * s, 8 * s, 9.5 * s, 2 * s);
        g.endFill();
        g.beginFill(0x4b5563);
        g.drawRoundedRect(-2.8 * s, -18.5 * s, 5.6 * s, 4.5 * s, 1.5 * s);
        g.endFill();
        ...
        g.beginFill(0x111827);
        g.drawRoundedRect(-2.8 * s, -25.5 * s, 5.6 * s, 6 * s, 2.4 * s);
        g.endFill();
        g.beginFill(0x38bdf8, 0.9);
        g.drawRoundedRect(-2 * s, -23.6 * s, 4 * s, 1.2 * s, 0.6 * s);
        g.endFill();
    },
    ...
    _ubtech(g, s) {
        ...
        g.drawRoundedRect(-2.6 * s, -27 * s, 5.2 * s, 4 * s, 1 * s);
        g.endFill();
        g.beginFill(0x4ade80);
        g.drawRect(-1.6 * s, -26.2 * s, 1 * s, 2.4 * s);
        g.endFill();
        // Torso — broad white industrial chest with navy trim
        g.beginFill(0xeef0f2);
        g.drawRoundedRect(-5 * s, -25 * s, 10 * s, 11.5 * s, 2 * s);
        g.endFill();
        g.beginFill(0x1d4ed8);
        ...
        g.beginFill(0xeef0f2);
        g.drawRoundedRect(-3 * s, -31.5 * s, 6 * s, 6.2 * s, 2 * s);
        g.endFill();
        g.beginFill(0x172554);
        g.drawRoundedRect(-2.4 * s, -30.4 * s, 4.8 * s, 2.8 * s, 1.2 * s);
        g.endFill();
        g.beginFill(0x60a5fa, 0.9);
        g.drawRect(-1.7 * s, -29.7 * s, 3.4 * s, 1 * s);
        g.endFill();
    },
};
